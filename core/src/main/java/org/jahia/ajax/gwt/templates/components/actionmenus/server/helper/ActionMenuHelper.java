...
//                }
                ...
                // Paste reference
                if (pastedType != null && ActionMenuLabelProvider.CONTAINER.equals(pastedType) && ClipboardHelper.clipboardContentHasActiveEntry(session, jParams.getLocale())) { // paste only container reference
