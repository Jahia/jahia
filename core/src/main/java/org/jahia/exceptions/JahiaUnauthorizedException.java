...
/**
 * Indicates that requested resource requires authentication, i.e. a valid user
 * (not a guest).
 * 
...
public class JahiaUnauthorizedException extends JahiaRuntimeException {
     ...
     * @param cause
     */
    public JahiaUnauthorizedException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause
     */
    public JahiaUnauthorizedException(Throwable cause) {
        super(cause);
    }
