...
public class RenderTimeLimitExceededException extends JahiaServiceUnavailableException {
     ...
     * @param message
     *            the error message
     * @param requestRenderTime
     *            the current request rendering time
     * @param maxRequestRenderTime
     *            the maximum time, allowed for request rendering
     */
    public RenderTimeLimitExceededException(String message, long requestRenderTime, long maxRequestRenderTime) {
        super(message);
        this.requestRenderTime = requestRenderTime;
