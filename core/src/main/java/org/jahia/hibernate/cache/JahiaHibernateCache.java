...
import org.jahia.services.cache.clusterservice.ClusterServiceCacheImpl;
 ...
 */
public class JahiaHibernateCache extends ClusterServiceCacheImpl implements Cache {
    public JahiaHibernateCache(String name, JGroupsClusterService clusterService, CacheImplementation underlyingCacheImplementation) {
        super(name, clusterService, underlyingCacheImplementation);
    }
