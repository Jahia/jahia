 ...
 *
 * @hibernate.subclass discriminator-value="org.jahia.hibernate.model.indexingjob.JahiaContainerListIndexingJob"
 */
public class JahiaContainerListIndexingJob extends JahiaIndexingJob {

    private Integer ctnListId;
    private Integer siteId = new Integer(0);

    public JahiaContainerListIndexingJob(){
        super();
        setClassName(getClass().getName());
    }

    public JahiaContainerListIndexingJob(int ctnListId, long date){
        this();
        setCtnListId(new Integer(ctnListId));
        setDate(new Long(date));
    }

    /**
     * @hibernate.property column="ctnlistid_indexingjob"
     * @return
     */
    public Integer getCtnListId() {
        return ctnListId;
    }

    public void setCtnListId(Integer ctnListId) {
    ...
    public Integer getSiteId() {
        if ( siteId.intValue() == 0 ){
            try {
                if ( ctnListId != null ){
                    ContentContainerList ctnList = ContentContainerList.getContainerList(ctnListId.intValue());
                    siteId = new Integer(ctnList.getSiteID());
                }
            } catch ( Exception t ){
            }
        }
    ...
    public boolean isValid(){
        try {
            return ( ContentContainerList.getContainerList(this.ctnListId.intValue()) != null );
        } catch (Exception t){
        }
        return false;
    }
    ...
    public void execute(JahiaUser user){
        if ( ctnListId != null ){
            ServicesRegistry.getInstance().getJahiaSearchService()
                .indexContainerList(ctnListId.intValue(),user,false,false);
        }
    }

    public void prepareBatchIndexation(List toRemove, List toAdd, JahiaUser user){
        //@todo , what to index for containerlist
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && this.getClass() == obj.getClass()) {
            final JahiaContainerListIndexingJob castOther = (JahiaContainerListIndexingJob) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        JahiaContainerListIndexingJob job = new JahiaContainerListIndexingJob();
        ...
        job.setCtnListId(this.getCtnListId());
