 ...
 */
public class JahiaDeleteIndexJob extends JahiaIndexingJob {

    private static org.apache.log4j.Logger logger =
            org.apache.log4j.Logger.getLogger(JahiaDeleteIndexJob.class);

    private Integer siteId = new Integer(0);

    public JahiaDeleteIndexJob(){
        super();
        this.setClassName(getClass().getName());
    }

    public JahiaDeleteIndexJob(int siteId, long date)
    {
        this();
    ...
    public void prepareBatchIndexation(List<RemovableDocument> toRemove,
            List<IndexableDocument> toAdd, JahiaUser user) {
        return;
    }
    ...
    public void execute(JahiaUser user){
        try {
            ServicesRegistry.getInstance().getJahiaSearchService()
                .deleteIndexForSite(siteId.intValue(), user, false);
        } catch ( Exception t){
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && this.getClass() == obj.getClass()) {
            final JahiaDeleteIndexJob castOther = (JahiaDeleteIndexJob) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        JahiaDeleteIndexJob job = new JahiaDeleteIndexJob();
