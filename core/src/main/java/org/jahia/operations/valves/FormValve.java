...
public class FormValve implements Valve {
    ...
    public void invoke(Object context, ValveContext valveContext) throws PipelineException {
        if (context instanceof ParamBean) {
            ...
            String token = jParams.getRequest().getParameter("formToken");
            if (tokens.containsKey(token)) {
                ...
                try {
                    ...
                    if (type.equals("createNode")) {
                        ...
                        setProperties(child, jParams.getRequest(), token);
                        parent.save();
                        ...
                        setProperties(node, jParams.getRequest(), token);
                        node.save();
    ...
    private void setProperties(Node n, ServletRequest r, String tok) throws RepositoryException {
