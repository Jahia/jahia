 ...
 */
public class JCIFSAuthValveImpl extends BaseAuthValve {
            ...
            if (principal != null) {
                ...
                if (logger.isDebugEnabled()) {
                    logger.debug("Found user " + userName +
                            "  passed by JCIFS filter, using it to try to login...(Principal.toString=" + principal);
                }
                try {
                    JahiaUser jahiaUser =
                    ...
                    if (jahiaUser != null) {
                        if (isAccounteLocked(jahiaUser)) {
                            logger.debug("Login failed. Account is locked for user " + userName);
                            return;
                        }
