...
/**
 *
 * <p>Title: Resource Bundle Definition</p>
 * <p>Description: </p>
...
public class ResourceBundleDefinition {
    ...
    public ResourceBundleDefinition( String resourceBundleID,
     ...
     *
     * @return resource bunlde file name
     */
    public String getResourceBundleFile(){
        return this.resourceBundleFile;
    }
}