...
/**
 * Working memory fact containing aggregated events.
 * 
 * @author Sergiy Shyrkov
 */
public class AggregatedNotificationEvent {
     ...
     */
    public AggregatedNotificationEvent() {
        super();
        events = new LinkedList<NotificationEvent>();
    }
