...
/**
 * Property iterator that is able to filter out "unwanted" properties.
 */
abstract class FilteredPropertyIterator implements PropertyIterator {
    private transient static Logger logger = LoggerFactory.getLogger(FilteredPropertyIterator.class);
    ...
    private void prefetch() {
        try {
            ...
            } while (nextProperty != null && isFiltered(nextProperty.getName()));
    ...
    abstract boolean isFiltered(String propertyName) throws RepositoryException;
}