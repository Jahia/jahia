...
public class FileEvents {
    public static final String FILES_EVENT_KEY = "org/jahia/services/content/files/";
    public static final String FILE_DOWNLOADED_EVENT_KEY = FILES_EVENT_KEY + "file/DOWNLOAD";
