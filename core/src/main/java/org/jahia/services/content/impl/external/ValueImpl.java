...
/**
 * Implementation of the {@link javax.jcr.Value} for the {@link org.jahia.services.content.impl.external.ExternalData}.
 * User: loom
 * Date: Aug 12, 2010
 * Time: 3:04:33 PM
 * 
...
public class ValueImpl implements Value {
    ...
    public ValueImpl(BigDecimal value) {
    ...
    public ValueImpl(Node value, boolean weakReference) throws RepositoryException {
        if (weakReference) {
