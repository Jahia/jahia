...
public class JahiaClientCapabilities implements ClientCapabilities {

    private String clientAgent;

    /**
     * Constructor initialized with the Client Agent value
     *
     * @param clientAgent
     */
    public JahiaClientCapabilities(String clientAgent){
