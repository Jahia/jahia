...
public class ImportExportBaseService extends JahiaService implements ImportExportService {
    ...
    private void exportSiteInfos(OutputStream out, ProcessingContext jParams, JahiaSite s) throws IOException {
        ...
        for (Iterator iterator = settings.keySet().iterator(); iterator.hasNext();) {
            ...
            if (s1.startsWith("prod_") || s1.startsWith("html_") || s1.startsWith("wai_") || s1.startsWith("url_") || s1.equals("org.jahia.theme.name")) {
        ...
        while (true) {
            ...
            if (name.indexOf('/') > -1) {
                ...
                for (Iterator iterator = keys.iterator(); iterator.hasNext();) {
                    ...
                    if (property.equals("org.jahia.theme.name")) {
                        siteSettings = true;
