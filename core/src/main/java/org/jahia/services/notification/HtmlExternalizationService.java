 ...
 * @deprecated Will be replaced by a more generic solution in the future
                ...
                if (useServletContextResources || request == null || response == null) {
                    ...
                    if (href.startsWith("/modules/")) {
                        ...
                        if (pack != null) {
                            ...
                            styleSheetContent = StringUtils.join(IOUtils.readLines(pack.getModuleResource(StringUtils.substringAfter(after, "/")).getInputStream()),'\n');
                        }
                    } else {
