...
public abstract class ConditionalExecution {
     ...
     *
     * @param condition
     *            the condition to be added for this filter
     */
    ...
    /**
     * Comma-separated list of resource configuration this filter will be executed for (all others are skipped).
     *
     * @param configurations
     *            comma-separated list of configurations this filter will be executed for (all others are skipped)
     */
    ...
    /**
     * If set to <code>true</code>, the current filter will only be executed on the main resource.
     *
     * @param bool
     *            set to <code>true</code> to limit filter execution for main resource only.
     */
    ...
    /**
     * Comma-separated list of modes this filter will be executed for (all others are skipped).
     *
     * @param modes
     *            comma-separated list of modes this filter will be executed for (all others are skipped)
     */
     ...
     *
     * @param applyOnEditMode
     *            true to apply this configuration
     */
    ...
    /**
     * Comma-separated list of module names this filter will be executed for (all others are skipped).
     *
     * @param modules
     *            comma-separated list of module names this filter will be executed for (all others are skipped)
     */
    ...
    /**
     * Comma-separated list of node type names this filter will be executed for (all others are skipped).
     *
     * @param nodeTypes
     *            comma-separated list of node type names this filter will be executed for (all others are skipped)
     */
    ...
    /**
     * Comma-separated list of template names this filter will be executed for (all others are skipped).
     *
     * @param templates
     *            comma-separated list of template names this filter will be executed for (all others are skipped)
     */
    ...
    /**
     * Adds specified conditions to the list of filter conditions. N.B. this operation does not reset the list of conditions, but rather
     * appends specified list to the current one.
     *
     * @param conditions
     *            list of conditions to be added for this filter
     */
    ...
    /**
     * Comma-separated list of configuration names this filter won't be executed for.
     *
     * @param configurations
     *            comma-separated list of node type names this filter won't be executed for
     */
     ...
     *
     * @param bool
     *            set to <code>true</code> to prevent filter from executing on main module
     */
    ...
    /**
     * Comma-separated list of mode names this filter won't be executed for.
     *
     * @param modes
     *            comma-separated list of node type names this filter won't be executed for
     */
    ...
    /**
     * Comma-separated list of template type names this filter won't be executed for.
     *
     * @param templateTypes
     *            comma-separated list of template type names this filter won't be executed for
     */
