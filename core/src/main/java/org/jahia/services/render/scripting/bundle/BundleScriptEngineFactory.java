 ...
 */
public class BundleScriptEngineFactory implements ScriptEngineFactory {

    private ScriptEngineFactory factory;
    private ClassLoader contextClassLoader;

    public BundleScriptEngineFactory(ScriptEngineFactory factory, ClassLoader contextClassLoader) {
