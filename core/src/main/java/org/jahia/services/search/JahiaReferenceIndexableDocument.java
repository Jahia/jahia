 ...
 *
 */
public class JahiaReferenceIndexableDocument extends IndexableDocumentImpl {

    private static final long serialVersionUID = 6871138387196706233L;

    private static org.apache.log4j.Logger logger =
            org.apache.log4j.Logger.getLogger(JahiaReferenceIndexableDocument.class);
    ...
    public JahiaReferenceIndexableDocument(JahiaField theField, String referenceId) {

        super();
        this.field = theField;
        this.referenceId = referenceId;
        this.setKeyFieldName(JahiaSearchConstant.COMP_ID);
        this.setKey(getCompId(field, referenceId));
    }
    ...
    public static final String getCompId(JahiaField field, String referenceId) {
