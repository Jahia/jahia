...
public abstract class JahiaFacetingService extends JahiaService {
    public abstract FacetBean createFacetFilter(String facetName, String propertyName,
    ...
    public abstract String[] getFacetFilterQueries(String filtersToApply, ContainerQueryContext queryContext,
