...
/**
 * Jahia specific implementation of the {@link UrlRewriteFilter} that multiple
 * configuration resources lookup support and other features.
 * 
 * @author Sergiy Shyrkov
 */
public class UrlRewriteFilterBean implements Filter {
	
	private static final Logger logger = LoggerFactory.getLogger(UrlRewriteFilterBean.class);
