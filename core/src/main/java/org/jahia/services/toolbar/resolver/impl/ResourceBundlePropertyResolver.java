...
public class ResourceBundlePropertyResolver implements PropertyResolver {
    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(ResourceBundlePropertyResolver.class);

    public String getValue(JahiaData jData, String input) {
        return getResources(jData.getProcessingContext(), input);
    }
