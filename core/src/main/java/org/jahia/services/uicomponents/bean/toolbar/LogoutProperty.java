...
public class LogoutProperty extends Property {
    ...
    public void setConfig(LogoutConfig config) {
        this.config = config;
    }

    @Override
    public String getRealValue(JCRSiteNode site, JahiaUser user, Locale locale, HttpServletRequest request) {
        final String customLogoutUrl = config.getCustomLogoutUrl(request);
        return customLogoutUrl != null ? customLogoutUrl : super.getRealValue(site, user, locale, request);
    }
}
