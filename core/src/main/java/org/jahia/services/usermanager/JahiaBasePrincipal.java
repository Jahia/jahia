...
public abstract class JahiaBasePrincipal implements JahiaPrincipal {
    ...
    public boolean hasRole(String role) {
        return isRoot() || getRoleBasedAccessControlService().hasRole(this, role);
    }

    public boolean hasRoles(Collection<String> roles) {
        return isRoot() || getRoleBasedAccessControlService().hasRoles(this, roles);
    }

    public boolean isPermitted(Collection<String> permissions) {
        return isRoot() || getRoleBasedAccessControlService().isPermitted(this, permissions);
    }

    public boolean isPermitted(String permission) {
        return isRoot() || getRoleBasedAccessControlService().isPermitted(this, permission);
    }
