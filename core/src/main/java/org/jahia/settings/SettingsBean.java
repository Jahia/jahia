...
public class SettingsBean implements ServletContextAware, InitializingBean, ApplicationContextAware {
    ...
    /**
     * Returns the directory where the automatic error reports are generated by Digital Factory.
     * 
     * @return the directory where the automatic error reports are generated by Digital Factory
     */
    ...
    /**
     * Returns the directory where the automatic or triggered thread dumps are generated by Digital Factory.
     * 
     * @return the directory where the automatic or triggered thread dumps are generated by Digital Factory
     */
    ...
    /**
     * Returns the directory where the triggered heap dumps are generated by Digital Factory.
     * 
     * @return the directory where the triggered heap dumps are generated by Digital Factory
     */
