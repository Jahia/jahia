...
/**
 * <p>Title: File path resolver</p>
 * <p>Description: Resolves all the paths as disk paths, basically performing
 * no transformation on the path and returning it as it is.</p>
