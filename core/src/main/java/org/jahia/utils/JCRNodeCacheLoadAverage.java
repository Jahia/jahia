...
public class JCRNodeCacheLoadAverage extends LoadAverage {
    ...
    public JCRNodeCacheLoadAverage(String threadName) {
        super(threadName);
        instance = this;
    }
    ...
    public double getCount() {
        int s = 0;
        for (JCRSessionWrapper sessionsObject : JCRSessionWrapper.getActiveSessionsObjects().values()) {
            s += sessionsObject.getCacheSize();
        }
        return (double) s;
    }
