...
#  $MOZILLAPATH http://localhost:8080/html/startup/loadingjahia.html &
#else
...
#    $NETSCAPEPATH http://localhost:8080/html/startup/loadingjahia.html &
#  else
#    echo Netscape not found. Please point your browser to the following URL : http://localhost:8080/
#  fi
#fi
