 ...
 */
public class GWTJahiaRawField implements Serializable {
    ...
    public GWTJahiaRawField() {
    }

    public GWTJahiaRawField(String name, String title, String icon, boolean bigText, String originalValue, String newValue,
