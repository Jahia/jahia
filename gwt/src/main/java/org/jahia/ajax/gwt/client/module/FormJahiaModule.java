                    ...
                    save.addSelectionListener(new SelectionListener<ButtonEvent>() {
                        public void componentSelected(ButtonEvent event) {
                            ...
                            if (action.equals("createNode")) {
                                ...
                                JahiaContentManagementService.App.getInstance().createNode(target, "node" + System.currentTimeMillis(), nodeType, null, null, pe.getProperties(), captchaValue, new AsyncCallback<GWTJahiaNode>() {
                                    public void onFailure(Throwable caught) {
