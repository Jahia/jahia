...
/**
 * Responsible for displaying of the action menu control.
 *
 * @author rfelden
...
public class ActionMenuDisplay extends FlexTable {
    ...
    public ActionMenuDisplay(GWTJahiaPageContext page, String objectKey,
            GWTJahiaGlobalState globalState, String bundleName, String namePostFix,
            String labelKey, String iconStyle, boolean disableToolbarView) {
        super();
