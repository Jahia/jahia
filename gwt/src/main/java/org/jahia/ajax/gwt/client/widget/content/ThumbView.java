...
//                view.getSelectionModel().select(0);
    ...
    public void setContent(Object root) {
        ...
        if (root != null) {
            ...
            service.ls((GWTJahiaNode) root, configuration.getNodeTypes(), configuration.getMimeTypes(), configuration.getFilters(), null, !configuration.isAllowCollections(), new AsyncCallback<List<GWTJahiaNode>>() {
