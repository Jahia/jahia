        ...
        RpcProxy<List<GWTJahiaNode>> proxy = new RpcProxy<List<GWTJahiaNode>>() {
            ...
            protected void load(Object gwtJahiaFolder, AsyncCallback<List<GWTJahiaNode>> callback) {
                if (gwtJahiaFolder == null) {
                    service.getRoot(JCRClientUtils.GLOBAL_REPOSITORY, JCRClientUtils.FOLDER_NODETYPES, null, null, null, null, callback);
                } else {
                    service.ls((GWTJahiaNode) gwtJahiaFolder, JCRClientUtils.FOLDER_NODETYPES, null, null, false, callback);
                }
