...
import org.jahia.ajax.gwt.client.widget.node.ContentToolbar;
import org.jahia.ajax.gwt.client.widget.node.ContentStatusBar;
...
public class ContentManager extends TriPanelBrowserViewport {
    ...
    public ContentManager(String types, String filters, String mimeTypes, String conf) {
        ...
        LeftComponent tree = new ContentTrees(config);
