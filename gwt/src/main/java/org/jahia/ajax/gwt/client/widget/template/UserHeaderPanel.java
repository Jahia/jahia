 ...
 * Time: 14:45:58
 */
public class UserHeaderPanel extends HorizontalPanel {
    ...
    private void init() {
        ...
        addStyleName("gwt-engineuserheader");
        Label userLabel = new Label("Utilisateur:" + JahiaGWTParameters.getCurrentUser());
