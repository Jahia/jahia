...
public class AjaxActionActionItem extends BaseActionItem {
   ...
   * */
    ...
    public native void displayPieChart(Element element)
       ...
       var size        = this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::getSize()();
       var statType    = this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::getStatType()();
        ...
        for( i=0; i < size ; i++)
       {
           var element = this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::pickElementFromTable()();
           data.setValue(i, 0, ''+i);
           var value = this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::getElementValue(Ljava/lang/String;)(element);
           data.setValue(i, 1, value);
           this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::removePickedElement(Ljava/lang/String;)(element);
       }
       options = {};
       options['width'] = 400;
       options['height'] = 240;
   ...
   * */
    ...
    public native void displayGeoMap(Element element)
        /*-{
          ...
          for( i=0; i < size ; i++)
          {
                var country = this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::pickAcountry()();
                data.setValue(i, 0, country);
                var value = this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::getCountryValue(Ljava/lang/String;)(country);
                data.setValue(i, 1, value);
                this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::removePickedCountry(Ljava/lang/String;)(country);
          }
   ...
   * */
    public native void displayAnnotatedTimeLine(Element element)
        ...
        for( i=0; i < size ; i++)
        {
             var date = this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::pickAdate()();
             data.setValue(i, 0, new Date(date));
             var value = this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::getValueSpark(Ljava/lang/String;)(date);
             data.setValue(i, 1, value);
             this.@org.jahia.ajax.gwt.client.widget.toolbar.action.AjaxActionActionItem::removePickedDate(Ljava/lang/String;)(date);
        }
