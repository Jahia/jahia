...
public class GWTJahiaUserProperty implements Serializable {
    ...
    private List<BasicDataBean> values;
    private BasicDataBean value;
    ...
    public List<BasicDataBean> getValues() {
        return values;
    }

    public void setValues(List<BasicDataBean> values) {
        this.values = values;
    }

    public BasicDataBean getValue() {
        return value;
    }

    public void setValue(BasicDataBean value) {
        this.value = value;
    }
}
