 ...
 */
public class GWTLanguageSwitcherBean implements Serializable{
    private Map<String,String> availableLanguages;
    private Map<String,String> workflowStates;

    public GWTLanguageSwitcherBean () {
    }

    public GWTLanguageSwitcherBean (Map<String,String> availableLanguages, Map<String, String> workflowStates) {
