 ...
 */
public class GWTVersion extends BaseModelData implements Serializable {
    ...
    public GWTVersion(String versionableUUID, long date, String name, String readableName, String lang,
