...
public interface JahiaServiceAsync {
    ...
    void saveUserProperties(GWTJahiaPageContext page, List<GWTPageUserProperty> properties, AsyncCallback async);
    ...
    void drawPortletInstanceOutput(GWTJahiaPageContext page, String windowID, String entryPointIDStr, String pathInfo, String queryString, AsyncCallback<GWTPortletOutputBean> async);
    ...
    void loadRssFeed(GWTJahiaPageContext pageContext, String url, Integer maxEntries, AsyncCallback<GWTRSSFeed> async);

    void getAvailableLanguagesAndWorkflowStates (boolean displayIsoCode,boolean displayLanguage, boolean inEngine, AsyncCallback<GWTLanguageSwitcherBean> async) ;

    void inlineUpdateField(Integer containerID, Integer fieldID, String updatedContent, AsyncCallback<GWTInlineEditingResultBean> async);
