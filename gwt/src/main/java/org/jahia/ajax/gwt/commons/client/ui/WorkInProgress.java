...
public class WorkInProgress {
    ...
    public static native void init() /*-{
        ...
        $wnd.workInProgressOverlay.start = $wnd.workInProgressOverlay.launch = @org.jahia.ajax.gwt.commons.client.ui.WorkInProgress::show();
        $wnd.workInProgressOverlay.stop = @org.jahia.ajax.gwt.commons.client.ui.WorkInProgress::hide();
