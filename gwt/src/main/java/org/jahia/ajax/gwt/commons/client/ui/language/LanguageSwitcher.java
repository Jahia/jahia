...
package org.jahia.ajax.gwt.commons.client.ui.language;
...
import org.jahia.ajax.gwt.commons.client.beans.GWTLanguageSwitcherBean;
...
public class LanguageSwitcher extends HorizontalPanel {
    ...
    public void init () {
        ...
        service.getAvailableLanguagesAndWorkflowStates(displayIsoCode, displayLanguage, inEngine, new AsyncCallback<GWTLanguageSwitcherBean>() {
            public void onFailure (Throwable throwable) {
            }

            public void onSuccess (GWTLanguageSwitcherBean bean) {
