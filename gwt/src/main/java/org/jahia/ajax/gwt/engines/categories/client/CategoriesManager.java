...
import org.jahia.ajax.gwt.engines.categories.client.components.CategoriesTreeTable;
import org.jahia.ajax.gwt.engines.categories.client.components.CategoryDetails;
import org.jahia.ajax.gwt.engines.categories.client.components.CategoriesTopBar;
...
public class CategoriesManager extends TriPanelBrowserLayout {
    ...
    public CategoriesManager(final String rootKey) {
        super();
        setBorders(false);
        setBodyBorder(false);
        setWidth("100%");
        ...
        TopBar toolbar = new CategoriesTopBar(treeTable);
