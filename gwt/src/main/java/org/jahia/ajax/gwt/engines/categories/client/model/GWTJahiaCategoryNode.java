...
package org.jahia.ajax.gwt.engines.categories.client.model;
...
public class GWTJahiaCategoryNode extends BaseTreeModel implements Serializable {
    private List<GWTCategoryTitle> categoryTitles;

    public GWTJahiaCategoryNode() {
        super();
        setCategoryProperties(new ArrayList<GWTJahiaNodeProperty>());
        setCategoryTitles(new ArrayList<GWTCategoryTitle>());
    ...
    public List<GWTCategoryTitle> getCategoryTitles() {
        return categoryTitles;
    }

    public void setCategoryTitles(List<GWTCategoryTitle> categoryTitles) {
