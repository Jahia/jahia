...
package org.jahia.ajax.gwt.engines.categories.client.util;
...
import org.jahia.ajax.gwt.engines.categories.client.components.ImportFile;
import org.jahia.ajax.gwt.engines.categories.client.components.InfoEditor;
...
public abstract class CategoriesManagerActions {
     ...
     * @param linker
     */
    public static void importCategories(final BrowserLinker linker) {
        new ImportFile(linker);
    }
     ...
     * @param linker
     */
    public static void exportCategories(final BrowserLinker linker) {
        String exportUrl = CategoriesManagerEntryPoint.getExportActionURL();
        if (exportUrl != null) {
