...
public class ProcessJobOptionsComponent extends LeftComponent {
    ...
    public void createUI() {
        ...
        ContentPanel contentPanel = createFilteringContentPanel(ProcessDisplayEntryPoint.getResource("pd_filter_type"), typeDataList);
        ...
        contentPanel = createFilteringContentPanel(ProcessDisplayEntryPoint.getResource("pd_filter_status"), statusDataList);
        m_component.add(contentPanel);
