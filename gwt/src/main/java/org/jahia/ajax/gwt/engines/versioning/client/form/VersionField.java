...
package org.jahia.ajax.gwt.engines.versioning.client.form;
...
import org.jahia.ajax.gwt.commons.client.ui.menu.VersionMenu;
import org.jahia.ajax.gwt.commons.client.ui.menu.CalendarMenu;
import org.jahia.ajax.gwt.commons.client.ui.menu.VersionMenuItem;
import org.jahia.ajax.gwt.commons.client.ui.calendar.CalendarPicker;
import org.jahia.ajax.gwt.commons.client.ui.form.CalendarField;
import org.jahia.ajax.gwt.commons.client.beans.GWTVersion;
import org.jahia.ajax.gwt.engines.versioning.client.page.PageVersionsBrowser;
import org.jahia.ajax.gwt.engines.versioning.client.page.PageVersionMenuItem;
...
public class VersionField extends TriggerField<Date> implements VersionsBrowserListener {
    ...
    protected GWTVersion selectedVersion;
     ...
     * @param date
     */
    public VersionField(int startingPageID, Date date, GWTVersion version, boolean useVersion) {
        super();
    ...
    public void onSave(GWTVersion selectedVersion){
        focusValue = getValue();
    ...
    public void initFieldValue(Date date, GWTVersion version, boolean useVersion){
    ...
    public void setSelectedVersion(GWTVersion version){
        this.selectedVersion = version;
    ...
    public GWTVersion getSelectedVersion(){
