...
public class VersionFieldPanel extends VerticalPanel {
    ...
    public void updateVersionLabel(){
        ...
        if (this.versionField != null &&
            ...
            this.bottomMsg.setText(ResourceBundle.getNotEmptyResource("versioning_"+ GWTVersion.VERSION_LABEL,
    ...
    public void applyRevisionValuesToVersionField(GWTRevision revision){
