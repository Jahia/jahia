...
public class VersionsData implements Serializable {
    ...
    private List<GWTVersion> versions;

    public VersionsData() {
    }

    public VersionsData(String[] versionRowDataHeadLabels, List<GWTVersion> versions) {
    ...
    public List<GWTVersion> getVersions() {
        return versions;
    }

    public void setVersions(List<GWTVersion> versions) {
        this.versions = versions;
    }
}
