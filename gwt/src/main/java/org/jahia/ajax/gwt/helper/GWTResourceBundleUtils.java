...
public final class GWTResourceBundleUtils {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GWTResourceBundleUtils.class);
    ...
    public static boolean store(GWTJahiaNode gwtNode, GWTResourceBundle bundle,
        ...
        try {
            ...
            for (String lang : bundle.getLanguages()) {
                ...
                InputStream is = null;
                try {
                    is = new ByteArrayInputStream(getAsString(lang, bundle).getBytes(StandardCharsets.ISO_8859_1));
                    if (current == null) {
                        // new language
