...
public class SchedulerHelper {
    private final Logger logger = LoggerFactory.getLogger(SchedulerHelper.class);
...
//            }
    ...
    class PollingSchedulerListener extends JobListenerSupport {
        ...
        public void jobToBeExecuted(JobExecutionContext context) {
            ...
            updateJobs(Collections.singletonList(contextJobDetail), Collections.emptyList());
        ...
        public void jobWasExecuted(JobExecutionContext context, JobExecutionException jobException) {
            JobDetail contextJobDetail = context.getJobDetail();
            updateJobs(Collections.emptyList(), Collections.singletonList(contextJobDetail));
        ...
        private void updateJobs(List<JobDetail> startedJob, List<JobDetail> endedJob) {
            try {
                ...
                if (broadcasterFactory != null) {
                    ...
                    logger.debug("Broadcasting job event: {} started, {} ended, total count: {}", startedJob.size(), endedJob.size(), totalCount);
