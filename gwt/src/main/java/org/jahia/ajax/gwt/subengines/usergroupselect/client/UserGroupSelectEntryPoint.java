...
package org.jahia.ajax.gwt.subengines.usergroupselect.client;
...
public class UserGroupSelectEntryPoint {
    ...
    private native void initJavaScriptApi() /*-{
        ...
        $wnd.openUserGroupSelect = function (mode,id,pattern) { @org.jahia.ajax.gwt.subengines.usergroupselect.client.UserGroupSelectEntryPoint::openUserGroupSelect(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(mode,id,pattern) };
    }-*/;
