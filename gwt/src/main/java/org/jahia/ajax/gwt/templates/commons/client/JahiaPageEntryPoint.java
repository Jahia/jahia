...
package org.jahia.ajax.gwt.templates.commons.client;
...
import org.jahia.ajax.gwt.javascriptapi.client.JavaScriptApi;
...
public abstract class JahiaPageEntryPoint implements EntryPoint {
    ...
    private native void initJavaScriptApi() /*-{
        ...
        $wnd.loadRSS = function (elementId, url, numberPage) {@org.jahia.ajax.gwt.templates.components.rss.client.RSSJahiaModule::loadRSS(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(elementId, url, numberPage); };
    }-*/;
