...
package org.jahia.ajax.gwt.templates.components.inlineediting.client.ui;
...
public class InlineEditing extends FocusPanel implements ClickListener {
    ...
    public void onBrowserEvent(Event event) {
        ...
        if (event.getTypeInt() == Event.ONCLICK) {
            ...
            JahiaService.App.getInstance().inlineUpdateField(containerID, fieldID, content, new AsyncCallback<GWTInlineEditingResultBean>() {
