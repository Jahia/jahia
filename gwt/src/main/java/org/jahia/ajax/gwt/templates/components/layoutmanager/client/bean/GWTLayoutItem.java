...
package org.jahia.ajax.gwt.templates.components.layoutmanager.client.bean;
 ...
 * Time: 11:19:43
 */
public class GWTLayoutItem implements Serializable {
    ...
    public GWTLayoutItem() {
    }

    public GWTLayoutItem(GWTJahiaNode gwtJahiaNode, int column, int row, String status) {
