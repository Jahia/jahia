...
package org.jahia.ajax.gwt.templates.components.layoutmanager.client.service;
...
public interface LayoutmanagerService extends RemoteService {
    ...
    public String saveLayoutItem(GWTJahiaPageContext pageContext, GWTLayoutItem draggableWidgetPreferences) throws GWTJahiaServiceException;

    public void saveAsDefault(GWTJahiaPageContext jahiaPageContext) throws GWTJahiaServiceException;

    public void removeLayoutItem(GWTJahiaPageContext pageContext, GWTLayoutItem draggableWidgetPreferences) throws GWTJahiaServiceException;
    ...
    public GWTLayoutManagerConfig getLayoutmanagerConfig() throws GWTJahiaServiceException;
    ...
    public List<GWTLayoutItem> getLayoutItems(GWTJahiaPageContext page) throws GWTJahiaServiceException;

    public GWTRSSFeed loalRssFeed(GWTJahiaPageContext pageContext, String url) throws GWTJahiaServiceException;
