...
package org.jahia.ajax.gwt.templates.components.layoutmanager.client.ui.gxt;
...
import org.jahia.ajax.gwt.templates.components.layoutmanager.client.ui.gxt.listener.OnPortletMovedListener;
import org.jahia.ajax.gwt.templates.components.layoutmanager.client.ui.gxt.portlet.*;
import org.jahia.ajax.gwt.templates.components.layoutmanager.client.ui.gxt.picker.JahiaPortletPicker;
import org.jahia.ajax.gwt.templates.components.layoutmanager.client.ui.gxt.picker.JahiaPortletPickerDialog;
...
public class JahiaPortalManager extends ContentPanel {
    ...
    private GWTLayoutManagerConfig gwtPortalConfig;
    private static boolean isLiveMode = !JahiaPageEntryPoint.getJahiaGWTPage().getMode().equalsIgnoreCase("edit");


    public JahiaPortalManager(GWTLayoutManagerConfig gwtPortalConfig) {
        super(new RowLayout());
        dis = this;
    ...
    public GWTLayoutManagerConfig getGwtPortalConfig() {
        return gwtPortalConfig;
    }

    public void setGwtPortalConfig(GWTLayoutManagerConfig gwtPortalConfig) {
        this.gwtPortalConfig = gwtPortalConfig;
    }
    ...
    public void setPortletFactory(JahiaPortletFactory portletFactory) {
    ...
    private void loadPortlets() {
        ...
        LayoutmanagerService.App.getInstance().getLayoutItems(JahiaPageEntryPoint.getJahiaGWTPage(), new AsyncCallback() {
            public void onSuccess(Object o) {
                // get user properties
                List<GWTLayoutItem> draggableWidgetList = (List<GWTLayoutItem>) o;
     ...
     */
    private void fillJahiaPortal(List<GWTLayoutItem> gwtLayoutItems) {
        if (gwtLayoutItems != null) {
            for (GWTLayoutItem gwtLayoutItem : gwtLayoutItems) {
   ...
   public void addJahiaPortlet(GWTLayoutItem gwtLayoutItem) {
        ...
        if (portlet != null) {
            ...
            Log.warn("Portlet with id: " + gwtLayoutItem.getWindowId());
        }
        layout();
    }
    ...
    public static JahiaPortlet createJahiaPortlet(final GWTLayoutItem gwtLayoutItem) {
