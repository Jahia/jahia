...
package org.jahia.ajax.gwt.templates.components.layoutmanager.client.ui.gxt.listener;
...
import org.jahia.ajax.gwt.templates.components.layoutmanager.client.ui.gxt.portlet.JahiaPortlet;
import org.jahia.ajax.gwt.templates.components.layoutmanager.client.ui.gxt.portlet.JahiaPortal;
...
public class OnPortletMovedListener implements Listener<PortalEvent> {
     ...
     * @param portlet
     */
    private void updateLayoutItems(List<GWTLayoutItem> layoutItems, JahiaPortlet portlet) {
        // get prferences object
        GWTLayoutItem gwtLayoutItem = portlet.getPorletConfig();
