...
package org.jahia.ajax.gwt.templates.components.opensearch.client;

import com.google.gwt.user.client.ui.*;
import com.extjs.gxt.ui.client.event.ComponentEvent;
import com.extjs.gxt.ui.client.widget.MessageBox;
import org.jahia.ajax.gwt.templates.commons.client.module.JahiaModule;
import org.jahia.ajax.gwt.templates.components.opensearch.client.ui.*;
...
public class JahiaOpenSearchTriPanel extends TriPanelBrowserLayout {
    ...
    public void onOpenSearchEngineStandAloneWindowClick(ComponentEvent event){
        GWTOpenSearchEngine openSearchEngine = this.leftPanel.getCurrentSelectedSearchEngine();
    ...
    public void onGroupSelectChange(GWTOpenSearchEngineGroup searchGroup){
        GWTOpenSearchEngine currentSelectedSearchEngine = this.leftPanel.getCurrentSelectedSearchEngine();
    ...
    public void onSearchEngineSelected(GWTOpenSearchEngine searchEngine) {
        this.layoutView.onSearchEngineSelected(searchEngine);
        this.toolBar.onSearchEngineSelected(searchEngine);
    }

    public void onSearchEngineChecked(GWTOpenSearchEngine searchEngine) {
