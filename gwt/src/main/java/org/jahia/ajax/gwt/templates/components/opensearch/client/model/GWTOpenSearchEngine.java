 ...
 */
public class GWTOpenSearchEngine implements Serializable {
    ...
    private GWTOpenSearchDescriptor descriptor;

    public GWTOpenSearchEngine() {
     ...
     * @throws Exception
     */
    public GWTOpenSearchEngine(String name, String urlType,
                        String descriptorType, GWTOpenSearchDescriptor descriptor) {
        this.name = name;
    ...
    public GWTOpenSearchDescriptor getDescriptor() {
        return descriptor;
    }
    ...
    public void setDescriptor(GWTOpenSearchDescriptor descriptor) {
        this.descriptor = descriptor;
    }
    ...
    private boolean hasRssSearchURL(){
        if (this.descriptor != null){
            for (URL url : this.descriptor.getUrls()){
