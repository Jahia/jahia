...
public class URLTemplate implements Serializable {
    ...
    public URLTemplate(String template, Map<String, Namespace> namespaces) {
    ...
    private void parseParameters(Map<String, Namespace> namespaces){
        ...
        if ( pos != -1 ){
            ...
            for (int i=0; i<tokens.length; i++){
                ...
                parameterName = ParameterName.getParameterName(paramTokens[0],namespaces);
                parameter = new Parameter(parameterName,paramTokens[1]);
