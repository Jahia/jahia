...
public class OpenSearchDefaultLayoutView extends OpenSearchLayoutView {
    ...
    public void onGroupSelectChange(GWTOpenSearchEngineGroup searchGroup,
                                    GWTOpenSearchEngine currentSelectedSearchEngine) {
        if (!searchGroup.getName().equals(this.currentGroupName)){
            ...
            for (GWTOpenSearchEngine searchEngine : searchGroup.getSearchEngines()){
    ...
    private interface ViewLayout {
        ...
        public abstract void onSearchEngineChecked(GWTOpenSearchEngine searchEngine);

        public abstract void onSearchEngineSelected(GWTOpenSearchEngine searchEngine);
