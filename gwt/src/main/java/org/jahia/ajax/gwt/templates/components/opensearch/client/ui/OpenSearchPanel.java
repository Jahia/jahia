...
public class OpenSearchPanel extends ContentPanel {
     ...
     * @param rssFeedMode
     */
    public OpenSearchPanel(GWTOpenSearchEngine searchEngine, boolean rssFeedMode) {
        this(searchEngine,null,rssFeedMode);
    }

    public OpenSearchPanel(GWTOpenSearchEngine searchEngine, String searchTerms, boolean rssFeedMode) {
        super(new FitLayout());
