...
public class SearchEngineGroupPanel extends ContentPanel {
    ...
    private GWTOpenSearchEngineGroup searchEngineGroup;
    private DataList searchEngines = new DataList();
    private int index;

    public SearchEngineGroupPanel(GWTOpenSearchEngineGroup searchEngineGroup, JahiaOpenSearchTriPanel openSearchTriPanel) {
        super(new FitLayout());
    ...
    public SearchEngineGroupPanel(Layout layout, GWTOpenSearchEngineGroup searchEngineGroup,
    ...
    public GWTOpenSearchEngine getSelectedSearchEngine() {
    ...
    public SearchEngineListItem addSearchEngine(GWTOpenSearchEngine searchEngine){
    ...
    public GWTOpenSearchEngineGroup getSearchEngineGroup() {
    ...
    private void init(){
        ...
        List<GWTOpenSearchEngine> gwtSearchEngines = this.searchEngineGroup.getSearchEngines();
        boolean hasEnabledSearchEngine = false;
        for (GWTOpenSearchEngine searchEngine : gwtSearchEngines){
