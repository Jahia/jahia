...
public class VerticalJahiaToolbar extends JahiaToolbar {
    public VerticalJahiaToolbar(GWTToolbar gwtToolbar) {
        super(gwtToolbar);
    }

    public VerticalJahiaToolbar(ToolbarManager toolbarManager, GWTToolbar gwtToolbar) {
    ...
    public void createToolBarUI() {
        if (!loaded) {
            ...
            for (int i = 0; i < toolbarList.size(); i++) {
                GWTToolbarItemsGroup gwtToolbarItemsGroup = (GWTToolbarItemsGroup) toolbarList.get(i);
     ...
     * @return
     */
    private ContentPanel createContentPanel(final GWTToolbarItemsGroup gwtToolbarItemsGroup, final ContentPanel toolbarAccordion) {
        ...
        for (int i = 0; i < toolbarItemsGroupList.size(); i++) {
            ...
            if (toolbarItemWidgetProvider == null && !isSeparator(gwtToolbarItem)) {
                ...
                if (!isSeparator(gwtToolbarItem)) {
                    ...
                    if (layout == Constants.ITEMSGROUP_BOX) {
                        ...
                        //make list checkable
                        if (layout == Constants.ITEMSGROUP_MENU_RADIO) {
