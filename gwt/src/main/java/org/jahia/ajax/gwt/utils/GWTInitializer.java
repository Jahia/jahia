...
import static org.jahia.utils.CKEditorUtils.getCustomCKEditorConfig;
...
public class GWTInitializer {
    ...
    public static String generateInitializerStructure(HttpServletRequest request, HttpServletResponse response, HttpSession session, Locale locale, Locale uilocale) {
        ...
        if (request.getAttribute("url") != null) {
            ...
            params.put(JahiaGWTParameters.BASE_URL, contextPath + Render.getRenderServletPath() + "/" + params.get("workspace") + "/" + locale);
            params.put(JahiaGWTParameters.EDIT_URL, contextPath + "/cms/edit/" + params.get("workspace") + "/" + locale);
        }
        ...
        String customCkeditorConfig = getCustomCKEditorConfig(request, renderContext, getConfig().isDetectCustomCKEditorConfig());
        if (customCkeditorConfig != null) {
