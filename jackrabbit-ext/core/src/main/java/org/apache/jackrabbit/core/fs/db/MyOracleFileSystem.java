 ...
 * </pre>
 */
public class MyOracleFileSystem extends DbFileSystem {
    ...
    protected Blob createTemporaryBlob(InputStream in) throws Exception {
        ...
        return blob;
        */
        Connection realCon = con;

        if (con instanceof org.apache.commons.dbcp.DelegatingConnection) {
            Connection pc = ((org.apache.commons.dbcp.DelegatingConnection)con).getDelegate();
            realCon = ((org.apache.commons.dbcp.DelegatingConnection)pc).getDelegate();
        }

        Method createTemporary = blobClass.getMethod("createTemporary",
                new Class[]{Connection.class, Boolean.TYPE, Integer.TYPE});
        Object blob = createTemporary.invoke(null,
                new Object[]{realCon, Boolean.FALSE, durationSessionConstant});
