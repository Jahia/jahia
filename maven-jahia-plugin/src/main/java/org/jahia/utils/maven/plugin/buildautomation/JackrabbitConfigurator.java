...
public class JackrabbitConfigurator extends AbstractConfigurator {
    ...
    public static void updateConfiguration(String sourceFileName, String destFileName, Map values, String cluster_activated, String cluster_node_serverId) throws IOException {
