...
public class JahiaXmlConfigurator extends AbstractConfigurator {
    ...
    public static void updateConfiguration(String sourceFileName, String destFileName, Map values, String username, String password, String url) throws IOException {
