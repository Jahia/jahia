...
jQuery.fn.datetime = function() {
    ...
    return this.each(function() {
        ...
        $(this).bind('focus', function() {
            ...
            if ($(this).data('userLang') != $('#pickerplug').data('userLang') || $(this).data('b24Hour') != $('#pickerplug').data('userLang')) {
        ...
        function parseTime(obj) {
            ...
            $('#datepicker').datepicker('setDate', $.datepicker.parseDate(datepicker_def['dateFormat'], $('#pickerplug').data('lastdate')));
        }
        ...
        function closePickPlug(event) {
            ...
            if (($(event.target).parents('#pickerplug').length || $(event.target).hasClass(markerClass)) && !$(event.target).hasClass('ui-datepicker-close')) {
                return;
            }
