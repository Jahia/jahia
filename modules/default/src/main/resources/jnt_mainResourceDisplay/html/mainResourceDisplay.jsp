...
<c:choose>
    ...
    <c:otherwise>
        <template:area view="${mainTemplate}" mockupStyle="${currentNode.properties['j:mockupStyle'].string}" templateType="${renderContext.mainResource.templateType}" editable="true" moduleType="existingNode"/>
    </c:otherwise>
</c:choose>
