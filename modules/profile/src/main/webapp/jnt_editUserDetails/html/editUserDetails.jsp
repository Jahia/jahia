...
<c:if test="${currentNode.properties['j:firstName'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:firstName')}"> jcr:id="j:firstName" class="edit${currentNode.identifier}"
                  id="edit_firstName" <c:if test="${empty fields['j:firstName']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:firstName")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:lastName'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:lastName')}"> jcr:id="j:lastName" class="edit${currentNode.identifier}"
                  id="edit_lastName" <c:if test="${empty fields['j:lastName']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:lastName")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:picture'].boolean}">
        ...
        <div class="userPicture${currentNode.identifier}" jcr:id="j:picture" id="edit_picture"<c:if test="${empty fields['j:picture']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:picture")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:birthDate'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:birthDate')}"> jcr:id="j:birthDate" class="dateEdit${currentNode.identifier}"
                 id="dateEdit_birthDate" <c:if test="${empty fields['j:birthDate']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:birthDate")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:organization'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:organization')}"> jcr:id="j:organization" class="edit${currentNode.identifier}"
                  id="edit_organization" <c:if test="${empty fields['j:organization']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:organization")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:function'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:function')}"> jcr:id="j:function" class="edit${currentNode.identifier}"
                  id="edit_function" <c:if test="${empty fields['j:function']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:function")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:about'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:about')}"> jcr:id="j:about" class="ckeditorEdit${currentNode.identifier}"
                  id="ckeditorEdit_about" <c:if test="${empty fields['j:about']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:about")%>"</c:if>
                  ckeditor:type="Mini"
    ...
    <c:if test="${currentNode.properties['j:email'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:email')}"> jcr:id="j:email" class="edit${currentNode.identifier}"
                  id="edit_email" <c:if test="${empty fields['j:email']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:email")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:skypeID'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:skypeID')}"> jcr:id="j:skypeID" class="edit${currentNode.identifier}"
                  id="edit_skypeID" <c:if test="${empty fields['j:skypeID']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:skypeID")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:twitterID'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:twitterID')}"> jcr:id="j:twitterID" class="edit${currentNode.identifier}"
                  id="edit_twitterID" <c:if test="${empty fields['j:twitterID']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:twitterID")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:facebookID'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:facebookID')}"> jcr:id="j:facebookID" class="edit${currentNode.identifier}"
                  id="edit_facebookID" <c:if test="${empty fields['j:facebookID']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:facebookID")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['j:linkedinID'].boolean}">
        <li>
            ...
            <span <c:if test="${user:isPropertyEditable(user,'j:linkedinID')}"> jcr:id="j:linkedinID" class="edit${currentNode.identifier}"
                  id="edit_linkedinID" <c:if test="${empty fields['j:linkedinID']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "j:linkedinID")%>"</c:if>
    ...
    <c:if test="${currentNode.properties['preferredLanguage'].boolean}">
        <li>
            ...
            <span jcr:id="preferredLanguage" class="choicelistEdit${currentNode.identifier}"
                  id="edit_preferredLanguage"  jcr:url="<c:url value='${url.basePreview}${user.path}'/>" <c:if test="${empty fields['preferredLanguage']}">init:data="<%= getPublicPropertiesData((JCRNodeWrapper)pageContext.getAttribute("user"), "preferredLanguage")%>"</c:if>
