...
<li><a href="<c:url value='${url.mainResource}?displayTab=${currentNode.name}${currentResource.moduleParams.ps}'/>"${tabCssClass}><span>${fn:escapeXml(currentNode.displayableName)}</span></a></li>
