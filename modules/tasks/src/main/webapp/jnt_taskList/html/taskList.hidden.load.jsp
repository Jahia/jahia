...
<c:if test="${not empty currentNode.properties['filterOnTypes']}">
    <query:definition var="listQuery"
                      statement="select * from [jnt:task] as t where isdescendantnode(t,['${bindedComponent}']) and t.type='${currentNode.properties['filterOnTypes'].string}' order by [jcr:created] desc"/>
</c:if>
<c:if test="${empty currentNode.properties['filterOnTypes']}">
    <query:definition var="listQuery"
                      statement="select * from [jnt:task] as t where isdescendantnode(t,['${bindedComponent}']) order by [jcr:created] desc"/>
</c:if>
