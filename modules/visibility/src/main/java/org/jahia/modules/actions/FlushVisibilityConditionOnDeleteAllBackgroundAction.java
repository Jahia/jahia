 ...
 * Created : 8/29/11
 */
public class FlushVisibilityConditionOnDeleteAllBackgroundAction implements BackgroundAction {
    private transient static Logger logger = LoggerFactory.getLogger(FlushVisibilityConditionOnDeleteAllBackgroundAction.class);
    ...
    public String getName() {
        return "flushVisibilityOnDeleteAll";
    }

    public void executeBackgroundAction(JCRNodeWrapper node) {
        try {
            cacheProvider.invalidate(node.getPath());
