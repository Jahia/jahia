...
rem mvndeploy GROUP_ID ARTIFACT_ID VERSION_ID PATH_TO_MAVEN1_REPOSITORY
rem 
...
rem
echo on
mvn deploy:deploy-file -DgroupId=%1 -DartifactId=%2 -Dversion=%3 -Dpackaging=jar -Dfile=%4/%1/jars/%2-%3.jar -DrepositoryId=jahiaRepository -Durl=scp://maven.jahia.org/var/www/vhosts/maven.jahia.org/html/maven2