...
public class ExternalOfficeManagerConfiguration {
    ...
    public OfficeManager buildOfficeManager() {
        UnoUrl unoUrl = connectionProtocol == OfficeConnectionProtocol.SOCKET ? (host != null ? UnoUrl.socket(host, portNumber) : UnoUrl.socket(portNumber)) : UnoUrl.pipe(pipeName);
