...
public class CListPaginationGetPageCountTag extends AbstractJahiaTag {
    ...
    private static final org.apache.log4j.Logger logger =
            org.apache.log4j.Logger.getLogger(CListPaginationGetPageCountTag.class);
    ...
    public int doStartTag() {
        ...
        if (containerListPaginationTag == null) {
            JahiaConsole.println("CListPaginationGetPageCountTag: doStartTag", "No container list pagination tag found !!");
            return SKIP_BODY;
        }

        final int value = containerListPaginationTag.getNbPages();
