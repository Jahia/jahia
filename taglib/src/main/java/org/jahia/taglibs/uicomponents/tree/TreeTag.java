...
public class TreeTag extends BodyTagSupport {
    ...
    private void init () {
        ...
        RequestBean requestBean = (RequestBean) pageContext.findAttribute(
            "currentRequest");
    ...
    private void startNextNode (JspWriter out, String actionURL)
        ...
        if (!node.isLeaf() && tree.isExpanded(new TreePath(node.getPath()))) {
            ...
            displayIcon(collapseIcon, JahiaResourceBundle.getCommonResource(
                ...
                processingContext), null, null, null, null, "absmiddle", out);
            out.print("</a>");
        } else if (!node.isLeaf()) {
            ...
            displayIcon(expandAllIcon,
                        ...
                        getCommonResource(
                            ...
                            processingContext), null, null, null, null,
                        "absmiddle", out);
            out.print("</a>");
            ...
            displayIcon(expandIcon,
                        JahiaResourceBundle.getCommonResource(
                            ...
                            processingContext), null, null, null, null, "absmiddle",
                        out);
            out.print("</a>");
        } else {
