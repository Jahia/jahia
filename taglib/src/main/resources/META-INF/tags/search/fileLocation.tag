...
<c:set target="${attributes}" property="id" value="${functions:default(attributes.id, 'src_fileLocation.value')}"/>
<c:set var="value" value="${functions:default(param['src_fileLocation.value'], value)}"/>
...
<c:set var="includeChildren"
       value="${functions:default(param['src_fileLocation.includeChildren'], empty paramValues['src_fileLocation.value'] ? includeChildren : 'false')}"/>
