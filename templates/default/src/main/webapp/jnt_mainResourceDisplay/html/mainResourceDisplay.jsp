...
<c:choose>
    <c:when test="${jcr:isNodeType(renderContext.mainResource.node, 'jnt:wrapper')}">
        <div style="width:100%; height:200px; overflow:hidden; background-color:#eaeaea; padding:5px; color:#ccc">
