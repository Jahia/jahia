...
<jcr:nodeProperty node="${currentNode}" name="widthFlashContainer1" var="widthFlash"/>
<jcr:nodeProperty node="${currentNode}" name="heightFlashContainer" var="heightFlash"/>
<jcr:nodeProperty node="${currentNode}" name="flashPlayerContainer" var="flashPlayer"/>
...
<jcr:nodeProperty node="${currentNode}" name="flashvarsFlashContainer" var="flashvarsFlash"/>
        ...
        <script type="text/javascript">
            var so = new SWFObject("${flashSource.file.downloadUrl}", "${nameFlash.string}", "${widthFlash.long}", "${heightFlash.long}", "${flashPlayer.string}", "${bgcolorFlash.string}");
