        ...
        <div class="eventsListItem"><!--start eventsListItem -->
            <div class="eventsInfoDate">
                <div class="eventsDate">
                    <span class="day"><fmt:formatDate pattern="dd" value="${startDate.date.time}"/></span>
                    <span class="month"><fmt:formatDate pattern="MM" value="${startDate.date.time}"/></span>
                    <span class="year"><fmt:formatDate pattern="yyyy" value="${startDate.date.time}"/></span>
                </div>
                <c:if test="${not empty endDate}">
                    ...
                    <div class="eventsDate">
                        <span class="day"><fmt:formatDate pattern="dd" value="${endDate.date.time}"/></span>
                        <span class="month"><fmt:formatDate pattern="MM" value="${endDate.date.time}"/></span>
                        <span class="year"><fmt:formatDate pattern="yyyy" value="${endDate.date.time}"/></span>
                    </div>
                </c:if>
            </div>
