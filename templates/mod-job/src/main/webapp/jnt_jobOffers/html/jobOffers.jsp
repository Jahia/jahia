	...
	<template:jahiaPageForm name="jobPageForm" method="get">
		<fieldset><legend><fmt:message key='jobSearchForm'/></legend>
			<p class="jobsSearchKeyword">
				...
				<input type="text" name="jobsSearchKeyword" id="jobsSearchKeyword" class="field jobsSearchKeyword" value="${param.jobsSearchKeyword}" tabindex="4" />
			</p>
			<div class="divButton">
				<input type="submit" name="submit" id="submit" class="button" value="<fmt:message key="search"/>" tabindex="5" />
			</div>
		</fieldset>
