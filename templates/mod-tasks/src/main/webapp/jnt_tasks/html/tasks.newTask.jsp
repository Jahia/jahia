            ...
            <form method="post" action="${url.base}${currentNode.path}/*">
              ...
              <fieldset><legend>NEW TASK</legend>
               ...
               <p><label for="task_dueDate" class="left">Due date:</label>
                  ...
                  <%--<p><label for="task_list" class="left">Target:</label>--%>

                      <%--<jcr:sql sql="select * from [jnt:tasks] as taskList" var="taskLists" />--%>
                    <%--<select id="task_list" class="combo" tabindex="21" >--%>

                    <%--<c:forEach items="${taskLists.nodes}" var="taskList">                        --%>
                        <%--<option value="${taskList.path}"> ${taskList.parent.name} </option>--%>
                    <%--</c:forEach>--%>
                    <%--</select></p>--%>
