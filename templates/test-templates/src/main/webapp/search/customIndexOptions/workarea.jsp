...
<div class="expectedResult">
  <fmt:message key="description.template.customIndexOptions.expectedResult"/>
</div>

<template:containerList name="fieldsWithIndexOptions" id="testContainerList" actionMenuNamePostFix="testContainers"
