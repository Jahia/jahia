...
<div class="box4 "><!--start box 4 default-->
    ...
    <h3 class="box4-header"><span class="publicationTitle"><utility:resourceBundle resourceName='lastEvents' defaultValue='Last events'/></span></h3>
...
<template:containerList name="events" id="eventsContainer"
                        actionMenuNamePostFix="events" actionMenuNameLabelKey="events" sortByField="${sortBy}" enforceDefinedSort="true" sortOrder="${order}">
