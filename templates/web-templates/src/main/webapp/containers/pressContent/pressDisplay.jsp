...
<div class="pressRealese"><!--start pressRealese -->
    <template:include page="containers/pressContent/pressTopDisplay.jsp"/>
    <div class="pressRealeseForm"><!--start pressRealeseForm -->
        <template:jahiaPageForm name="pressPageForm" method="get">
            <fieldset>
                ...
                <div class="divButton"><input type="submit" name="submit" id="submit" class="button" value="Rechercher"
                                              tabindex="7"/>
                </div>
            </fieldset>
    ...
    <template:containerList name="press" id="pressContainer" actionMenuNamePostFix="press"
                            actionMenuNameLabelKey="press" windowSize="10" sortByField="date" enforceDefinedSort="true" sortOrder="desc">
