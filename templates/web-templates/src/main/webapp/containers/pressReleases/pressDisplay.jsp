...
<div class="pressRealese"><!--start pressRealese -->
    <template:include page="containers/pressReleases/pressTopDisplay.jsp"/>
    <div class="pressRealeseForm"><!--start pressRealeseForm -->
        <template:jahiaPageForm name="pressPageForm" method="get">
            <fieldset>
                ...
                <div class="divButton"><input type="submit" name="submit" id="submit" class="button" value='<utility:resourceBundle resourceName="search"/>'
                                              tabindex="7"/>
                </div>
            </fieldset>
            <input type="hidden" name="web_templates_press_windowsize" value="5">
    ...
    <template:containerList name="press" id="pressContainer" actionMenuNamePostFix="press"
                            actionMenuNameLabelKey="pressReleases" windowSize="10" sortByField="date" enforceDefinedSort="true" sortOrder="desc">
