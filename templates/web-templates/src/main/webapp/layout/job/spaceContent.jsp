...
<div id="content2">
    ...
    <div class="spaceContent"><!--start spaceContent -->
        ...
        <template:include page="containers/jobContent/jobTopDisplay.jsp"/>
...
<!--start jobsSearchForm -->
		...
		<template:jahiaPageForm name="jobPageForm" method="get">
			...
			<p class="jobsSearchKeyword"><label for="jobsSearchKeyword"><utility:resourceBundle resourceName='keywordSearch' defaultValue="search by keyword"/></label>
...
<!--stop jobsSearchForm -->
        ...
        <template:include page="containers/jobContent/jobDisplay.jsp"/>
