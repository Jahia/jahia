...
<div id="content2">
    ...
    <div class="spaceContent"><!--start spaceContent -->
        ...
        <template:include page="containers/publicationContent/publicationTopDisplay.jsp"/>
        <template:include page="containers/publicationContent/publicationDisplay.jsp"/>
