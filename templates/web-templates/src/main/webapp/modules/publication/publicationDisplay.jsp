...
<template:containerList name="publication" id="publication"
                       actionMenuNamePostFix="publication" actionMenuNameLabelKey="publication.add">
    <%@ include file="publicationDisplay.jspf" %>
