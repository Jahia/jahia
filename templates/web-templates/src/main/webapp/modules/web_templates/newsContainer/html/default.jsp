...
<%@ taglib prefix="template" uri="http://www.jahia.org/tags/templateLib" %>
 ...
 <jcr:nodeProperty node="${currentNode}" name="newsImage" var="newsImage"/>
    ...
    <div class="newsListItem"><!--start newsListItem -->
        ...
        <h4><a href="${currentNode.path}">${newsTitle.string}</a></h4>
        ...
        <div class="newsImg"><a href="${currentNode.path}"><img src="${newsImage.node.url}"/></a></div>
        <p class="newsResume">
            ${newsDesc.string}
        </p>

        <div class="more"><span><a href="${currentNode.path}">
