...
<div id="content2">
    <div class="mainColumn"><!--start spaceContent -->
        ...
        <!-- page title is not usefull in article page <h2><c:out value="${requestScope.currentPage.highLightDiffTitle}" escapeXml="false"/></h2> -->
        <template:include page="containers/article/articleDisplay.jsp"/>
    </div>
    <!--stop space content-->
</div>
<!--stopContent-->