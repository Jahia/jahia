...
public class UserBO {
	...
	public Element getJcrXml() throws ParserConfigurationException {
...
/*		Element root = new Element("dj");
		...
		// @TODO : picture
		userElement.setAttribute("picture", "/users/dj/gi/ej/jenifer/files/profile/publisher.png", ContentGeneratorCst.NS_J); // 
		...
		//subElement1.appendChild(userElement);
		return userElement;
	}
}
