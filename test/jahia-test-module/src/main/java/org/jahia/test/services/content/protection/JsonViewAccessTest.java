...
public class JsonViewAccessTest extends JahiaTestCase {
    ...
    @Test
    public void guestHasAccessInLiveToSiteFolders() throws RepositoryException {
    ...
    @Test
    public void guestHasNoAccessInLiveToSiteFiles() throws RepositoryException {
        String sitePath = site.getJCRLocalPath();
    ...
    @Test
    public void guestHasNoAccessInLiveToSiteUserFolders() throws RepositoryException {
    ...
    @Test
    public void guestHasNoAccessInLiveToUserFilesAndFolder() throws RepositoryException {
        String root = editorFilesPath;
