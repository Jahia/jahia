...
public class RestApiAccessTest extends JahiaTestCase {
    ...
    @Test
    public void accessWithEditorUser() throws RepositoryException {
    ...
    @Test
    public void accessWithGuestToFoldersAndPages() throws RepositoryException {
    ...
    private void checkAccess(String url, boolean shouldHaveAccess) {
    ...
    private void checkNoAccess(String url, String workspace) {
        checkAccess("/modules/api/jcr/v1/" + workspace + "/en/paths" + url, false);
    }

    @Test
    public void noAccessToConfiguredNodeTypesToSkip() throws RepositoryException {
    ...
    @Test
    public void noAccessWithGuestToOtherContent() throws RepositoryException {
