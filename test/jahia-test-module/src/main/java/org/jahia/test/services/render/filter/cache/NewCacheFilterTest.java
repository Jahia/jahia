...
public class NewCacheFilterTest extends CacheFilterTest{
    ...
    public void testCacheFilter() throws Exception {
        ...
        RenderChain chain = new RenderChain(cacheFilter, outFilter);

        Map<String, Object> moduleMap = new HashMap<>();
        moduleMap.put(AggregateFilter.RENDERING_KEY, key);
        moduleMap.put(AggregateFilter.RENDERING_FINAL_KEY, generator.replacePlaceholdersInCacheKey(context, key));
