...
public class ModuleDeploymentTest {
    ...
    private static final String V_1_0_JAR = "-1.0.jar";
    ...
    public void clearDeployedModule() throws Exception {
        JCRTemplate.getInstance().doExecuteWithSystemSession(new JCRCallback<Object>() {
            ...
            public Object doInJCR(JCRSessionWrapper session) throws RepositoryException {
                ...
                JahiaTemplatesPackage oldpack = managerService.getTemplatePackageRegistry().lookupByIdAndVersion(DUMMY_1_MODULE, new ModuleVersion("1.0"));
                if (oldpack != null) {
                    managerService.undeployModule(oldpack);
                }
                oldpack = managerService.getTemplatePackageRegistry().lookupByIdAndVersion(DUMMY_1_MODULE, new ModuleVersion("1.1"));
                if (oldpack != null) {
                    managerService.undeployModule(oldpack);
                }

                SettingsBean settingsBean = SettingsBean.getInstance();
                FileUtils.deleteQuietly(new File(settingsBean.getJahiaModulesDiskPath(), DUMMY_1_MODULE + V_1_0_JAR));
                FileUtils.deleteQuietly(new File(settingsBean.getJahiaModulesDiskPath(), DUMMY_1_MODULE + "-1.1.jar"));
        ...
        JCRTemplate.getInstance().doExecuteWithSystemSession(new JCRCallback<Object>() {
            ...
            public Object doInJCR(JCRSessionWrapper session) throws RepositoryException {
                ...
                try {
                    ...
                    InputStream stream = managerService.getTemplatePackageById(JAHIA_TEST_MODULE).getResource(DUMMY_1_MODULE + V_1_0_JAR).getInputStream();
        ...
        JCRTemplate.getInstance().doExecuteWithSystemSession(new JCRCallback<Object>() {
            ...
            public Object doInJCR(JCRSessionWrapper session) throws RepositoryException {
                try {
                    ...
                    stream = managerService.getTemplatePackageById(JAHIA_TEST_MODULE).getResource(DUMMY_1_MODULE + "-1.1.jar").getInputStream();
                    FileUtils.copyInputStreamToFile(stream,  tmpFile);
                    managerService.deployModule(tmpFile, session);
                    tmpFile.delete();
                } catch (IOException e) {
            ...
            public Object doInJCR(JCRSessionWrapper session) throws RepositoryException {
                ...
                try {
                    ...
                    FileUtils.copyURLToFile(managerService.getTemplatePackageById(JAHIA_TEST_MODULE)
                            .getResource(DUMMY_1_MODULE + V_1_0_JAR).getURL(), tmpFile);
