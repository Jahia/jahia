...
*/
    ...
    private JCRSessionWrapper recycleSession(JCRPublicationService jcrService, String defaultLanguage, Locale englishLocale, JCRSessionWrapper currentSession, String workspaceName) throws RepositoryException {
