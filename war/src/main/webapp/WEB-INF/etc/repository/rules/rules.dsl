...
[condition][]A node is unpublished=node : PublishedNodeFact (translation == false, unpublished == true, $node : this)
[condition][]A translation is unpublished=node : PublishedNodeFact (translation == true, unpublished == true, $node : this)
...
[consequence][]Publish user profile picture {node}=service.publishProfilePicture({node}, drools);
...
[consequence][]Flush user cache for {node}=service.flushUserCache(node);
[consequence][]Flush group cache for {node}=service.flushGroupCache(node);
[consequence][]Flush group membership cache for {node}=service.flushGroupMembershipCache(node);
...
[consequence][]Notify {user} user with mail template "{template}" from {fromMail}=notificationService.notifyUser({user},"{template}",{fromMail},drools);
[consequence][]Notify {user} from site {site} with mail template "{template}" from "{fromMail}" copy to "{ccList}" blind copy to "{bccList}"=notificationService.notifyUser({user},{site},"{template}","{fromMail}","{ccList}","{bccList}",drools);
[consequence][]Notify {user} user from site {site} with mail template "{template}" from "{fromMail}"=notificationService.notifyUser({user},{site},"{template}","{fromMail}",drools);
[consequence][]Notify {user} user from site {site} with mail template "{template}" from {fromMail}=notificationService.notifyUser({user},{site},"{template}",{fromMail},drools);
...
[consequence][]Update work in progress state of descendants of site {node}=service.updateWipStatesIfNeeded({node}, drools);