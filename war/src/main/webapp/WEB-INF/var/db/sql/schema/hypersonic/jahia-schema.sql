    ...
    drop table jahia_acl if exists;

    drop table jahia_acl_entries if exists;

    drop table jahia_acl_names if exists;

    drop table jahia_app_def if exists;

    drop table jahia_appdef_prop if exists;

    drop table jahia_appentry if exists;

    drop table jahia_apps_share if exists;

    drop table jahia_audit_log if exists;

    drop table jahia_bigtext_data if exists;

    drop table jahia_category if exists;

    drop table jahia_category_prop if exists;

    drop table jahia_ctn_def if exists;

    drop table jahia_ctn_def_properties if exists;

    drop table jahia_ctn_entries if exists;

    drop table jahia_ctn_lists if exists;

    drop table jahia_ctn_struct if exists;

    drop table jahia_ctndef_prop if exists;

    drop table jahia_ctnentries_prop if exists;

    drop table jahia_ctnlists_prop if exists;

    drop table jahia_db_test if exists;

    drop table jahia_fieldreference if exists;

    drop table jahia_fields_data if exists;

    drop table jahia_fields_def if exists;

    drop table jahia_fields_def_extprop if exists;

    drop table jahia_fields_prop if exists;
    ...
    drop table jahia_locks_non_excl if exists;

    drop table jahia_nstep_workflow if exists;

    drop table jahia_nstep_workflowhistory if exists;

    drop table jahia_nstep_workflowinstance if exists;

    drop table jahia_nstep_workflowstep if exists;

    drop table jahia_nstep_workflowuser if exists;

    drop table jahia_obj if exists;

    drop table jahia_pages_data if exists;
    ...
    drop table jahia_retruledef if exists;

    drop table jahia_savedsearch if exists;

    drop table jahia_savedsearchview if exists;

    drop table jahia_serverprops if exists;

    drop table jahia_site_lang_list if exists;

    drop table jahia_site_lang_maps if exists;

    drop table jahia_site_prop if exists;

    drop table jahia_sites if exists;

    drop table jahia_sites_grps if exists;
    ...
    create table jahia_audit_log (
        ...
        eventInformation longvarbinary,
    ...
    create table jahia_category (
        ...
        key_category varchar(250) not null,
    ...
    create table jahia_savedsearch (
        ...
        search_jahia_savedsearch longvarchar not null,
    ...
    create table jahia_savedsearchview (
        ...
        setting_savedsearchview longvarchar not null,
