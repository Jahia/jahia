...
create index idx_qrtz_j_req_recovery on jahia_qrtz_job_details(REQUESTS_RECOVERY);
...
create index idx_qrtz_t_nft_st on jahia_qrtz_triggers(NEXT_FIRE_TIME,TRIGGER_STATE);
...
create index idx_qrtz_ft_trig_nm_gp on jahia_qrtz_fired_triggers(TRIGGER_NAME,TRIGGER_GROUP);
