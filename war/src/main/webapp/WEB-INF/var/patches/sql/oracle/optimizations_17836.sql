alter table jahia_acl add hasentries_jahia_acl number(10,0);
...
alter table jahia_pages_data modify language_code varchar2(10) not null;
...
alter table jahia_obj modify type_jahia_obj varchar2(22) not null;
