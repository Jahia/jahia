    ...
    <tr>
      <td valign="top">
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="2">
                        <br><fmt:message key="org.jahia.engines.users.SelectUG_Engine.search.label"/>&nbsp;:
                ...
                <tr>
                    <td>&nbsp;&nbsp;<fmt:message key="org.jahia.engines.users.SelectUG_Engine.in.label"/>&nbsp;:</td>
                    <td>
                        <input type="radio" name="searchIn" value="allProps" checked
                               onclick="disableCheckBox(properties);">&nbsp;<fmt:message key="org.jahia.engines.users.SelectUG_Engine.allProperties.label"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td valign="top">
                        <input type="radio" name="searchIn" value="properties"
                               onclick="enableCheckbox(properties);">&nbsp;<fmt:message key="org.jahia.engines.users.SelectUG_Engine.properties.label"/>&nbsp;:<br>
                        <!-- This following list is generated by JSP -->
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="properties" value="groupname" disabled>&nbsp;<fmt:message key="org.jahia.engines.groupname.label"/><br>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="properties" value="description" disabled>&nbsp;<fmt:message key="org.jahia.engines.users.SelectUG_Engine.description.label"/> (LDAP)<br>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <td>&nbsp;&nbsp;<fmt:message key="org.jahia.engines.users.SelectUG_Engine.on.label"/>&nbsp;:</td>
                    <td>
                        <input type="radio" name="storedOn" value="everywhere"
                               <%if (providerList.size() > 1) { %> checked <% } %>
                               onclick="disableCheckBox(providers);">&nbsp;<fmt:message key="org.jahia.engines.users.SelectUG_Engine.everywhere.label"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <input type="radio" name="storedOn" value="providers"
                               <%if (providerList.size() <= 1) { %> checked <% } %>
                               onclick="enableCheckbox(providers);">&nbsp;<fmt:message key="org.jahia.engines.users.SelectUG_Engine.providers.label"/>&nbsp;:<br>
<%
