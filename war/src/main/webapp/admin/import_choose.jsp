                          ...
                          <table border="0" cellpadding="0" width="100%">
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                JahiaTemplatesPackage pack = (JahiaTemplatesPackage) iterator1.next(); %><option value="<%=pack.getName()%>"<% if (pack.getName().equals(infos.get("templates"))) { %>selected<% } %>><%=pack.getName() %></option>
                                <%
                                } %>
                              </select>
                              </td>
