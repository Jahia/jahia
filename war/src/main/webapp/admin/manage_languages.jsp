...
<div id="topTitle">
  <h1>Jahia</h1>
  <h2 class="edit"><fmt:message key="org.jahia.admin.manageLanguages.label"/>: <% if ( currentSite!= null ){ %><fmt:message key="org.jahia.admin.site.label"/>&nbsp;<%=currentSite.getServerName() %>&nbsp;&nbsp;<%} %></h2>
</div>
<div id="main">
          ...
          <div class="dex-TabPanelBottom">
            ...
            <jsp:include page="/admin/include/left_menu.jsp">
              ...
              <div id="content" class="fit">
                <div class="head">
                  <div class="object-title">
                    <fmt:message key="org.jahia.admin.languages.ManageSiteLanguages.configuredLanguages.label"/>&nbsp;
                  </div>
                </div>
                <div class="content-body">
                  <div id="operationMenu">
                    * = <fmt:message key="org.jahia.admin.languages.ManageSiteLanguages.languagesUsedByHomePage.label"/>&nbsp;
                  </div>
                </div>
                <form name="mainForm" action='<%=JahiaAdministration.composeActionURL(request,response,"siteLanguages","&sub=commit")%>' method="post">
                  <table class="evenOddTable" border="0" cellpadding="5" cellspacing="0" style="width: 100%">
                    <thead>
                      <tr>
                        <th>
                          <fmt:message key="org.jahia.admin.languages.ManageSiteLanguages.rank.label"/>
                        </th>
                        <th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td colspan="5">
                          <b><fmt:message key="org.jahia.admin.languages.ManageSiteLanguages.noLanguageDefined.label"/></b>
                        </td>
                      </tr><%
                      } else {
                      ...
                      <label for="mixLanguages"><fmt:message key="org.jahia.admin.languages.ManageSiteLanguages.mixLanguages.label"/></label>
                      <br>
                            ...
                            <td>
                                <span class="dex-PushButton">
                                    <span class="first-child">
                                        <a class="add-lang" href="javascript:sendForm();" title="<fmt:message key='org.jahia.admin.languages.ManageSiteLanguages.addLanguages.label'/>"><fmt:message key="org.jahia.admin.languages.ManageSiteLanguages.addLanguages.label"/></a>
                                    </span>
                                </span>
                            </td>
                          </tr>
                      ...
                      <div class="head headtop">
                        <div class="object-title">
                          <fmt:message key="org.jahia.admin.languages.ManageSiteLanguages.languageMappings.label"/>
                        </div>
                      </div>
                      <table style="clear:both" class="text">
                        ...
                        <tr>
                          <td>
                            <fmt:message key="org.jahia.admin.languages.ManageSiteLanguages.noMappings.label"/>
                          </td>
                        </tr><%
                        }
              ...
              <div id="actionBar">
                ...
                <span class="dex-PushButton">
                  <span class="first-child">
                    <a class="ico-edit" href='<%=JahiaAdministration.composeActionURL(request,response,"siteLanguages","&sub=displayMappings")%>'><fmt:message key="org.jahia.admin.languages.ManageSiteLanguages.editLanguageMappings.label"/></a>
                  </span>
                </span>
                <span class="dex-PushButton">
                  <span class="first-child">
