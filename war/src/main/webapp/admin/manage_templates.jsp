...
<div id="topTitle">
  <h1>Jahia</h1>
  <h2 class="edit"><fmt:message key="label.manageTemplates"/><% if ( site!= null ){ %><fmt:message key="org.jahia.admin.site.label"/>&nbsp;:&nbsp;<%=site.getServerName() %><%} %></h2>
</div>
<div id="main">
              ...
              <div id="operationMenu">
                <span class="dex-PushButton">
                  <span class="first-child">
                     <a class="ico-tpl-view" href="<%=JahiaAdministration.composeActionURL(request, response, "templates", "&amp;sub=synchronize")%>" onclick="showWorkInProgress(); return true;" alt="<fmt:message key="org.jahia.admin.templates.ManageTemplates.synchTemplates.label"/>"><fmt:message key="label.templatesDeploy"/></a>
                  </span>
                </span>
