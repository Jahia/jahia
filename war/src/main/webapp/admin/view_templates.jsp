                            ...
                            <div class="content-item">
                                <table cellpadding="5" cellspacing="0" border="0">
                                    <tr>
                                        ...
                                        <td>
                                            ${fn:escapeXml(site.templatePackageName)}&nbsp;(${templateSetPackage.lastVersionFolder})
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <c:forEach var="module" items="${modules}">
                                                ...
                                                <c:if test="${pkg.moduleType == 'jahiapp'}">${found ? '<br/>' : ''}${fn:escapeXml(pkg.name)}&nbsp;(${pkg.lastVersionFolder})<c:set var="found" value="true"/></c:if>
                                            </c:forEach>
                                            <c:if test="${not found}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:forEach var="module" items="${modules}">
                                                <c:set var="pkg" value="${templatePackageByNodeName[module]}"/>
                                                <c:if test="${empty pkg.moduleType || pkg.moduleType == 'module' || pkg.moduleType == 'system'}">${found ? '<br/>' : ''}${fn:escapeXml(pkg.name)}&nbsp;(${pkg.lastVersionFolder})<c:set var="found" value="true"/></c:if>
                                            </c:forEach>
                                            <c:if test="${not found}">
                                                <fmt:message key="label.none"/>
                                            </c:if>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:forEach var="module" items="${modules}" varStatus="status">
                                                <c:set var="pkg" value="${templatePackageByNodeName[module]}"/>
                                                <c:if test="${pkg.moduleType == 'profileModule'}">${found ? '<br/>' : ''}${fn:escapeXml(pkg.name)}&nbsp;(${pkg.lastVersionFolder})<c:set var="found" value="true"/></c:if>
                                            </c:forEach>
                                            <c:if test="${not found}">
                                                <fmt:message key="label.none"/>
                                            </c:if>
