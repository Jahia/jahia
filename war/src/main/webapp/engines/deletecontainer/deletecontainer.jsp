...
<div id="header">
  <h1>Jahia</h1>
  <h2 class="delete"><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.deleteContainer.label"/></h2>
</div>
<div id="mainContent">
          ...
          <div class="dex-TabPanelBottom-full">
            <div class="tabContent">
              <div id="content" class="full">
                <% if (!error) {%>
                <div class="head">
                  <div class="object-title"><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.confirm.label"/></div>
                </div>
                <%}%>
                <div>
                  <% if (error) { %>
                    <p class="errorbold">
                       <fmt:message key="org.jahia.engines.deletecontainer.errorMessage"/>
                    </p>
                  <%} else {%>
                ...
                <% //check if files to delete
    						...
    						{ %>
    									...
    									<fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.deleteFiles"/>
    									<span  style="color: red;">(<fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.deleteFiles.warning"/>)</span>
                ...
                if (warning) {
                  ...
                  <% if (stagingWarning) { %>
                         <p><fmt:message key="org.jahia.stagingWarning.label"/></p>
                  <% } %>
                  <% if (!deletedPages.isEmpty()) {
                    if (deletedPages.size() > DeleteContainer_Engine.PAGE_LIST_SIZE_LIMIT) {%>
                      <fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.delPagesPartialList.label"/>:
                    <%} else {%>
                      <fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.delPages.label"/>:
                    <%}%>
                    <ul>
                      <%
                  ...
                  if (ctnPickers != null && ctnPickers.size() > 0) { %>
                    <fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.brokenPickers.label"/>:
                    <ul>
                      <%
                  ...
                  if (!deletedLinks.isEmpty()) {%>
                    <fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.delLinks.label"/>:
                    <ul>
                      <%
                      for (Iterator it = deletedLinks.iterator(); it.hasNext(); ) {
                        ...
                        if (aPage != null && aPage.getACL().getPermission(jParams.getUser(), JahiaBaseACL.READ_RIGHTS, true)) { %>
                          <li>
                            ...
                            (<fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.onPageId.label"/>:
                  ...
                  if (futureBrokenLinkObjects.size() > 0) { %>
                    <p><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.futureBrokenLinks.label"/>:<p>
                    <div class="inMiddle">
                      <table id="hardLinks">
                        <tr class="header">
                          <td>
                            <strong><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.type.label"/></strong>
                          </td>
                          <td>
                            <strong><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.subType.label"/></strong>
                          </td>
                          <td>
                            <strong><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.id.label"/></strong>
                          </td>
                          <td>
                            <strong><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.name.label"/></strong></td>
                          <td>
                            <strong><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.title.label"/></strong>
                          </td>
                          <td>
                            <strong><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.pageId.label"/></strong>
                          </td>
                          <td>
                            <strong><fmt:message key="org.jahia.engines.deletecontainer.DeleteContainer_Engine.pageTitle.label"/></strong>
                          </td>
                        </tr>
                        <%
