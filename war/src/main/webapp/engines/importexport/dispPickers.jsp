...
<TR><td width="48px">
<img src="<%=request.getContextPath()%>/engines/images/branch_view.gif" width="48" height="48" border="0"></td><td align="left"><h3><%=getRessource(pickersbundle, "pickers.","title")%></h3></td></tr>
<tr><td colspan="2">
