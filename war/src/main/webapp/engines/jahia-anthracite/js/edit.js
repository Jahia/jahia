...
(function (exposeAs) {
    ...
    var app = {
        ...
        disableV2: function () {
            app.data.V2Disabled = app.data.V2;
        ...
        backgroundJobs: {
            ...
            onOpen: function () {
                ...
                DexV2.class('job-list-window').filter('.x-window-bwrap .x-panel:nth-child(1) .x-panel-bwrap .x-panel-mc .x-panel-tbar')
                     .setAttribute('indigo-label', app.dictionary('jobs'));
                DexV2.class('job-list-window')
                     ...
                     .setAttribute('indigo-label', app.dictionary('autoRefresh'));
            ...
            buildFilterMenu: function () {
                ...
                var filters = app.backgroundJobs.data.filters;
        ...
        picker: {
            ...
            repositionSidePanel: function (splitterLeft) {
                ...
                var pickerTitle = (app.picker.data.standalone) ? DexV2('#pickerTitle')
                    : DexV2.id(app.picker.data.ID).filter('.x-window-tl .x-window-header-text');
            ...
            onOpen: function () {
                ...
                if (app.picker.data.standalone) {
                    ...
                    var pickerH1Label = document.createTextNode(app.dictionary('pickerTitle-' + app.data.HTTP.picker));
                ...
                if (DexV2.id(app.picker.data.ID).filter('#JahiaGxtManagerBottomTabs').exists()) {
                    ...
                    DexV2.id(app.picker.data.ID).onGroupOpen('#JahiaGxtManagerBottomTabs .x-grid-group', function () {
                    ...
                    DexV2.id(app.picker.data.ID).onGroupClose('.x-grid-group', function () {
                ...
                if (DexV2('body > #JahiaGxtContentPickerWindow #JahiaGxtManagerBottomTabs').exists()) {
                    ...
                    DexV2('body > #JahiaGxtContentPickerWindow #JahiaGxtManagerBottomTabs')
                        .onGroupClose('.x-grid-group', function () {
                            // Need to manually count the files in multiple selection ...
                            app.picker.data.selectedSubFileCount = DexV2('body > #JahiaGxtContentPickerWindow #JahiaGxtManagerBottomTabs')
            ...
            search: {
                setUpScreen: function () {
                    ...
                    var languageField = DexV2('#' + app.picker.data.ID + ' #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(2) input');
                    var fromDate = DexV2('#' + app.picker.data.ID + ' #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(5) input');
                    var toDate = DexV2('#' + app.picker.data.ID + ' #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(6) input');
                    var dateRange = DexV2('#' + app.picker.data.ID + ' #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(7) input');
                    ...
                    DexV2('#' + app.picker.data.ID + ' #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(7)')
                    ...
                    DexV2.id(app.picker.data.ID)
                         ...
                         .onClick(
                            '#' + app.picker.data.ID + ' #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(3)',
                            app.picker.search.updateMetaLabel, 'CHANGE_META_FILTER')
                         // Listen for changes to modification type ...
                         .onClick(
                            '#' + app.picker.data.ID + ' #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(4) .x-form-check-wrap',
                            app.picker.search.updateModificationLabel, 'CHANGE_MODIFICATION_FILTER')
                         // Toggle modification menu when clicking ...
                         .onClick(
                            '#' + app.picker.data.ID + ' #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(4) > label',
                            app.picker.search.toggleModificationMenu, 'TOGGLE_MODIFICATION_FILTER');
                ...
                setUpSubScreen: function () {
                    ...
                    DexV2('body > #JahiaGxtContentPickerWindow')
                        ...
                        .onClick('body > #JahiaGxtContentPickerWindow #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(3)',
                            app.picker.search.updateMetaLabel, 'CHANGE_META_FILTER_SUB')
                        ...
                        .onClick('body > #JahiaGxtContentPickerWindow #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(4) .x-form-check-wrap',
                            app.picker.search.updateModificationLabel, 'CHANGE_MODIFICATION_FILTER_SUB')
                        ...
                        .onClick('body > #JahiaGxtContentPickerWindow #JahiaGxtManagerLeftTree #CRTsearchTabItem .x-panel-mc > .x-panel-body > .x-component:nth-child(2) fieldset .x-form-item:nth-child(4) > label',
                            app.picker.search.toggleModificationMenu, 'TOGGLE_MODIFICATION_FILTER_SUB');
        ...
        engine: {
            ...
            onOpenWorkflow: function () {
                ...
                DexV2.node(this).onClick('.x-grid3-row', function () {
                    ...
                    var localisedLabel = app.dictionary('workflowType').replace('%n%', label);
                    var localisedChooseLabel = app.dictionary('chooseWorkflowType').replace('%n%', label);
            ...
            editCondition: function () {
                ...
                var doneButtonLabel = document.createTextNode(app.dictionary('save'));
            ...
            addCondition: function () {
                ...
                var saveButtonLabel = document.createTextNode(app.dictionary('create'));
                var closeButton = document.createElement('button');
                var closeButtonLabel = document.createTextNode(app.dictionary('cancel'));
            ...
            infoBar: {
                ...
                tasks: {
                    ...
                    updateMenuLabel: function () {
                        DexV2.node(this).filter('.toolbar-item-workflowdashboard').setHTML(app.edit.infoBar.data.dashboardButtonLabel);
                    }
                },
                jobs: {
                    data: {
            ...
            history: {
                ...
                get: function (type) {
                    ...
                    if (app.edit.history.data[type]) {
                        var stillInVisibleDOM = document.body.contains(app.edit.history.data[type]);
            ...
            sidepanel: {
                ...
                clipPageTitle: function () {
                    ...
                    if (DX.data.currentApp === 'edit') {
                        ...
                        var isWide = wideSidepanels.indexOf(app.edit.sidepanel.data.currentTab) > -1;
