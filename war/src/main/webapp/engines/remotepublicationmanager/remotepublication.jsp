...
<html>
<head>
    <title><internal:message key="label.remotepublicationmanager"/></title>
...
<internal:contentManager enginemode="true"
                      rootPath='/remotePublications'
                      nodeTypes="jnt:remotePublication"
                      conf="remotepublicationmanager"/>
