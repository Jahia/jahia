...
<script type="text/javascript" src="${pageContext.request.contextPath}/javascript/scriptaculous/scriptaculous-17-compressed.js"></script>
...
#columns li {
    ...
    margin: 3px;
    padding: 1px;
    background: url("${pageContext.request.contextPath}/engines/images/arrow_off.png") no-repeat 95%;
}
-->
</style>
