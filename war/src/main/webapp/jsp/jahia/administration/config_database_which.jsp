        ...
        <tr>
            <td nowrap>
                <font class="text">
                    ...
                    <internal:adminResourceBundle resourceName="org.jahia.admin.database.ManageDatabase.changeSettings.label"/>
                    <br><br>
                    <input type="radio" name="which_action" value="2">
                    <internal:adminResourceBundle resourceName="org.jahia.admin.database.ManageDatabase.transferValues.label"/>
                    <br><br>
                    <!--
                    <input disabled type="radio" name="which_action" value="3">
                    <em><internal:adminResourceBundle resourceName="org.jahia.admin.database.ManageDatabase.createBackup.label"/></em>
                    <br><br>
                    <input disabled type="radio" name="which_action" value="4">
                    <em><internal:adminResourceBundle resourceName="org.jahia.admin.database.ManageDatabase.manageBackups.label"/></em>
                    -->
                </font>
            </td>
        </tr>
