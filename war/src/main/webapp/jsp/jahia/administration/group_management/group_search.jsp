    ...
    <tr>
      <td valign="top">
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="2">
                        <br><utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.users.SelectUG_Engine.search.label"/>&nbsp;:
                ...
                <tr>
                    <td>&nbsp;&nbsp;<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.users.SelectUG_Engine.in.label"/>&nbsp;:</td>
                    <td>
                        <input type="radio" name="searchIn" value="allProps" checked
                               onclick="disableCheckBox(properties);">&nbsp;<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.users.SelectUG_Engine.allProperties.label"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td valign="top">
                        <input type="radio" name="searchIn" value="properties"
                               onclick="enableCheckbox(properties);">&nbsp;<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.users.SelectUG_Engine.properties.label"/>&nbsp;:<br>
                        <!-- This following list is generated by JSP -->
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="properties" value="groupname" disabled>&nbsp;<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.groupname.label"/><br>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="properties" value="description" disabled>&nbsp;<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.users.SelectUG_Engine.description.label"/> (LDAP)<br>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="properties" value="members" disabled>&nbsp;<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.users.SelectUG_Engine.members.label"/> (LDAP)<br>

                    </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.users.SelectUG_Engine.on.label"/>&nbsp;:</td>
                    <td>
                        <input type="radio" name="storedOn" value="everywhere"
                               <%if (providerList.size() > 1) { %> checked <% } %>
                               onclick="disableCheckBox(providers);">&nbsp;<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.users.SelectUG_Engine.everywhere.label"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <input type="radio" name="storedOn" value="providers"
                               <%if (providerList.size() <= 1) { %> checked <% } %>
                               onclick="enableCheckbox(providers);">&nbsp;<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.engines.users.SelectUG_Engine.providers.label"/>&nbsp;:<br>
<%
...
%>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="checkbox" name="providers" value="<%=curProvider.getKey()%>" disabled
                                <%if (providerList.size() <= 1) { %> checked <% } %>>
                            <utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName='<%= "org.jahia.engines.users.SelectUG_Engine.providers." + curProvider.getKey() + ".label"%>'/> (<%=curProvider.getKey()%>)<br>
<%
                        }
%>
                    </td>
                    ...
                    <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span class="first-child">
                                        ...
                                        title="<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName='org.jahia.admin.users.ManageGroups.altSortBySource.label'/>"><utility:resourceBundle resourceBundle="JahiaInternalResources"
                                                resourceName="org.jahia.admin.users.ManageGroups.altSortBySource.label"/></a>
                                    </span>
                                </span>
                                ...
                                <span class="dex-PushButton">
                                    <span class="first-child">
                                        ...
                                        title="<utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName='org.jahia.admin.users.ManageGroups.altSortByGroupId.label'/>"><utility:resourceBundle resourceBundle="JahiaInternalResources"
                                                resourceName="org.jahia.admin.users.ManageGroups.altSortByGroupId.label"/></a>
                                    </span>
                                </span>
                                ...
                                <span class="dex-PushButton">
                                 ...
                                 <!-- <a href="#"
                                       ...
                                       onMouseOver="MM_swapImage('helpSorting','','<%=request.getContextPath()%><utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.helpOn.button" />',1)">
                                       <img align="left" name="helpSorting" alt="Help on sorting ACL entries"
                                            ...
                                            src="<%=request.getContextPath()%><utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.helpOff.button" />"
                        ...
                        <select ondblclick="javascript:handleKey(event);"
                                ...
                                onkeydown="javascript:handleKeyCode(event.keyCode);"
                                 style="width:435px;"  name="selectedGroup" size="25" multiple>
                            <%
                                if (resultSet.size() == 0) {
