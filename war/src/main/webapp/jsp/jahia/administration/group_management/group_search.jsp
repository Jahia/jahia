    ...
    <tr>
      <td valign="top">
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="2">
                        <br><internal:engineResourceBundle resourceName="org.jahia.engines.users.SelectUG_Engine.search.label"/>&nbsp;:
                ...
                <tr>
                    <td>&nbsp;&nbsp;<internal:engineResourceBundle resourceName="org.jahia.engines.users.SelectUG_Engine.in.label"/>&nbsp;:</td>
                    <td>
                        <input type="radio" name="searchIn" value="allProps" checked
                               onclick="disableCheckBox(properties);">&nbsp;<internal:engineResourceBundle resourceName="org.jahia.engines.users.SelectUG_Engine.allProperties.label"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td valign="top">
                        <input type="radio" name="searchIn" value="properties"
                               onclick="enableCheckbox(properties);">&nbsp;<internal:engineResourceBundle resourceName="org.jahia.engines.users.SelectUG_Engine.properties.label"/>&nbsp;:<br>
                        <!-- This following list is generated by JSP -->
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="properties" value="groupname" disabled>&nbsp;<internal:engineResourceBundle resourceName="org.jahia.engines.groupname.label"/><br>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="properties" value="description" disabled>&nbsp;<internal:engineResourceBundle resourceName="org.jahia.engines.users.SelectUG_Engine.description.label"/> (LDAP)<br>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="properties" value="members" disabled>&nbsp;<internal:engineResourceBundle resourceName="org.jahia.engines.users.SelectUG_Engine.members.label"/> (LDAP)<br>

                    </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;<internal:engineResourceBundle resourceName="org.jahia.engines.users.SelectUG_Engine.on.label"/>&nbsp;:</td>
                    <td>
                        <input type="radio" name="storedOn" value="everywhere"
                               <%if (providerList.size() > 1) { %> checked <% } %>
                               onclick="disableCheckBox(providers);">&nbsp;<internal:engineResourceBundle resourceName="org.jahia.engines.users.SelectUG_Engine.everywhere.label"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <input type="radio" name="storedOn" value="providers"
                               <%if (providerList.size() <= 1) { %> checked <% } %>
                               onclick="enableCheckbox(providers);">&nbsp;<internal:engineResourceBundle resourceName="org.jahia.engines.users.SelectUG_Engine.providers.label"/>&nbsp;:<br>
<%
...
%>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="checkbox" name="providers" value="<%=curProvider.getKey()%>" disabled
                                <%if (providerList.size() <= 1) { %> checked <% } %>>
                            <internal:engineResourceBundle resourceName='<%= "org.jahia.engines.users.SelectUG_Engine.providers." + curProvider.getKey() + ".label"%>'/> (<%=curProvider.getKey()%>)<br>
<%
                        }
%>
                    </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span class="first-child">
                                        ...
                                        title="<internal:adminResourceBundle resourceName='org.jahia.admin.users.ManageGroups.altSortBySource.label'/>"><internal:adminResourceBundle
                                ...
                                <span class="dex-PushButton">
                                    <span class="first-child">
                                        ...
                                        title="<internal:adminResourceBundle resourceName='org.jahia.admin.users.ManageGroups.altSortByGroupId.label'/>"><internal:adminResourceBundle
                                ...
                                <span class="dex-PushButton">
                                 ...
                                 <!-- <a href="#"
                                       ...
                                       onMouseOver="MM_swapImage('helpSorting','','<%=request.getContextPath()%><internal:engineResourceBundle resourceName="org.jahia.helpOn.button" />',1)">
                                       <img align="left" name="helpSorting" alt="Help on sorting ACL entries"
                                            ...
                                            src="<%=request.getContextPath()%><internal:engineResourceBundle resourceName="org.jahia.helpOff.button" />"
