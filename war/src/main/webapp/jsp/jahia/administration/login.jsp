...
<h3 class="loginIcon"><internal:adminResourceBundle resourceName="org.jahia.admin.jahiaAdministration.label"/></h3>
<br class="clearFloat" />
...
<div id="actionBar" class="alignCenter">
  <span class="dex-PushButton">
    <span class="first-child">
      <a class="ico-ok" href="javascript:document.jahiaAdmin.submit();" tabindex="5" title="<internal:adminResourceBundle resourceName="org.jahia.bin.JahiaAdministration.login.label"/>"><internal:adminResourceBundle resourceName="org.jahia.bin.JahiaAdministration.login.label"/></a>
    </span>
  </span>
