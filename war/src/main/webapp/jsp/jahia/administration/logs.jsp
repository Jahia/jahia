    ...
    <tbody>
      ...
      <tr>
            ...
            <div id="content" class="fit">
              <div class="head">
                <div class="object-title">
                  <internal:adminResourceBundle resourceName="org.jahia.admin.ManageLogs.lastLogsSection.label"/>
                </div>
              </div>
              <form style="padding-top: 10px; padding-bottom: 10px" name="modifyLastLogs" action='<%=JahiaAdministration.composeActionURL(request,response,"logs","&sub=view")%>' method="post">
                <table border="0" cellpadding="4" cellspacing="0">
                    <tr>
                        <td><internal:adminResourceBundle resourceName="org.jahia.admin.audit.ManageLogs.viewLastLogsPrefix.label"/><input type="text" name="viewLastDays" value="<%=viewLastDays%>" size="5" />
                        <internal:adminResourceBundle resourceName="org.jahia.admin.audit.ManageLogs.viewLastLogsPostfix.label"/></td>
                        <td>
                            <span class="dex-PushButton">
                                <span class="first-child">
                                    <a class="ico-apply" href="javascript:document.modifyLastLogs.submit()"><internal:adminResourceBundle resourceName="org.jahia.admin.change.label"/></a>
                                </span>
                            </span>
                        </td>
                    </tr>
              ...
              <form name="jahiaAdmin" action='<%=JahiaAdministration.composeActionURL(request,response,"logs","&sub=flushconfirm")%>' method="post">
                <display-el:table class="evenOddTable tBorder bBorder" name="logData" cellspacing="0" cellpadding="1" style="width:100%; font-size:9px" pagesize="30" export="true" id="rowID">
                  <%@include file="/jsp/jahia/administration/include/displaytag_admin_properties.inc" %>
                ...
                <ul style="list-style-type: none">
                  <li>
                    <input class="input" type="radio" name="keeprecent" value="false"<%if(!keeprecentlogs.booleanValue()){ %>checked<%} %>> <internal:adminResourceBundle resourceName="org.jahia.admin.audit.ManageLogs.deleteAllLogEntries.label"/>
                  </li>
                  <li>
                    <input class="input" type="radio" name="keeprecent" value="true"<%if(keeprecentlogs.booleanValue()){ %>checked<%} %>> <internal:adminResourceBundle resourceName="org.jahia.admin.audit.ManageLogs.keepEntriesMoreRecentThan.label"/><input type="text" size="5" name="maxlogsdays" value="<%=maxlogsdays%>" onFocus="keeprecent[1].checked = true"><internal:adminResourceBundle resourceName="org.jahia.admin.audit.ManageLogs.day.label"/>
                  </li>
                </ul>
        ...
        <div id="actionBar">
          <span class="dex-PushButton">
            <span class="first-child">
              <a class="ico-back" href='<%=JahiaAdministration.composeActionURL(request,response,"logs","&sub=settings")%>'><internal:adminResourceBundle resourceName="org.jahia.admin.audit.ManageLogs.backToLogSettings.label"/></a>
            </span>
          </span>
          <span class="dex-PushButton">
            <span class="first-child">
              <a class="ico-flush" href="javascript:document.jahiaAdmin.submit()"><internal:adminResourceBundle resourceName="org.jahia.admin.flush.label"/></a>
            </span>
          </span>
        </div>
