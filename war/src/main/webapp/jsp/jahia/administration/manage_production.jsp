              ...
              <form name="mainForm" action='<%=JahiaAdministration.composeActionURL(request,response,"productionManager","&sub=commit")%>' method="post">
                ...
                <table border="0" cellpadding="5">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <utility:resourceBundle resourceBundle="JahiaInternalResources" resourceName="org.jahia.admin.productionManager.form.cron"/>&nbsp;<a href="#cronhelp" onclick="viewCronHelp(); return false;"><img src="${pageContext.request.contextPath}/jsp/jahia/engines/images/about.gif" alt="show cron help"/></a>
                      </td>
                      <td>
