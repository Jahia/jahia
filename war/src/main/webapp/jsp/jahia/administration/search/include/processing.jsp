...
<tr valign="top" class="greyed">
    ...
    <td align="left" valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr valign="top">
            ...
            <td width="30px">&nbsp;&nbsp;</td>
            <td align="left"><img src="<%=request.getContextPath()%>/jsp/jahia/engines/images/waiting.gif"></td>
        </tr></table>
...
<tr valign="top">
    ...
    <td align="left" valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr valign="top">
            ...
            <td align="left">
                <%
                    String url = request.getContextPath() + "/administration/?do=search&sub=display&?del=" + jd.getName() + "&delgroup=" + jd.getGroup();
                %>
                <a href="<%=url%>"><img src="<%=request.getContextPath()%>/jsp/jahia/engines/images/deleting.png"
                                        width="16" height="16"
                                        border="0"></a></td>
        </tr></table>
    </td>
    ...
    <td align="left" valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr valign="top">
            ...
            <td align="left">
                <%
                    if(theUser.isRoot()){
                    String url = request.getContextPath() + "/administration/?do=search&sub=display&?del=" + jd.getName();
                %>
                <a href="<%=url%>"><img src="<%=request.getContextPath()%>/jsp/jahia/engines/images/deleting.png"
                                        width="16" height="16"
                                        border="0"></a>
                ...
                <%
                    ...
                    if (result != null) {
                        ...
                        if (infoasked != null && infoasked.equalsIgnoreCase(jname)) {
                            ...
                            urlinfo = "<a href='" + request.getContextPath() + "/administration/?do=search&sub=display&command=past" + pars + "' title='fermer les infos'><img src='" + request.getContextPath() + "/jsp/jahia/engines/images/about.gif' width='16' height='16' border='0'></a>";
                        } else if(!failedjob) {
                            urlinfo = "";
							...
							if(cronlimit != null) pars += ("&cl=" + cronlimit);
                            if (jobstatus == 0)
                                urlinfo = "<img src='" + request.getContextPath() + "/jsp/jahia/engines/images/icons/workflow/errors.gif' width='9' height='10' border='0'>";
                            if (jobstatus == 1)
                                urlinfo = "<img src='" + request.getContextPath() + "/jsp/jahia/engines/images/icons/workflow/accept.gif' width='9' height='10' border='0'>";
                            if (jobstatus == 2)
                                urlinfo = "<img src='" + request.getContextPath() + "/jsp/jahia/engines/images/icons/workflow/warnings.gif' width='9' height='10' border='0'>";
                            urlinfo += "&nbsp;&nbsp;<a href='" + request.getContextPath() + "/administration/?do=search&sub=display&command=past&info=" + jd.getName() + pars + "' title='voir les infos'><img src='" + request.getContextPath() + "/jsp/jahia/engines/images/about.gif' width='16' height='16' border='0'></a>";
                        } else {
...
<tr><td colspan="3"></td><td bgcolor="#eeeeee"><br>
    ...
    switch (jobstatus) {
        case 0:
            // errors
%>
    <img src="<%=request.getContextPath()%>/jsp/jahia/engines/images/icons/workflow/errors.gif" width="9" height="10"
         border="0"> <%=getRessource("org.jahia.engines.processDisplay.error.message", locale)%>
    <%
            break;
        case 1:
    %>
    <img src="<%=request.getContextPath()%>/jsp/jahia/engines/images/icons/workflow/accept.gif" width="9" height="10"
    ...
    <%
        ...
        case 2:
            //warnings
    %>
    <img src="<%=request.getContextPath()%>/jsp/jahia/engines/images/icons/workflow/warnings.gif" width="9" height="10"
         border="0"> <%=getRessource("org.jahia.engines.processDisplay.error.message", locale)%>
    <%
          break;
    }    
    ...
    %>
      <a href="<%=request.getContextPath()%>/administration/?do=search&sub=displaylog&command=warn&jd=<%=jd.getName()%>"><%=getRessource("org.jahia.engines.processDisplay.allmessages.message", locale)%>
      </a>
    <%   
    }
    %>
