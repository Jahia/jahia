...
<div id="topTitle">
  <h1>Jahia</h1>
  <h2 class="edit"><internal:adminResourceBundle resourceName="org.jahia.admin.manageTemplates.label"/>
    <br>
    <% if ( site!= null ){ %><internal:adminResourceBundle resourceName="org.jahia.admin.site.label"/>&nbsp;:&nbsp;<%=site.getServerName() %><%} %>
  </h2>
</div>
<div id="main">
...
--%>              
                ...
                <form name="mainForm" action="" method="post">
                  <table border="0" cellpadding="5" cellspacing="0">
                    <tr>
                      <td>
                        <label for="autoDeploy"><internal:adminResourceBundle resourceName="org.jahia.admin.templates.ManageTemplates.automaticDeployment.label"/></label>
                      </td>
                      <td>
        ...
        <div id="actionBar">
          <span class="dex-PushButton">
            <span class="first-child">
              <a class="ico-back" href='<%=JahiaAdministration.composeActionURL(request,response,"templates","&sub=display")%>'><internal:adminResourceBundle resourceName="org.jahia.admin.templates.ManageTemplates.backToTemplatesList.label"/></a>
            </span>
          </span>
          <span class="dex-PushButton">
            <span class="first-child">
              <a class="ico-reset" href="javascript:document.mainForm.reset()"><internal:adminResourceBundle resourceName="org.jahia.admin.resetChanges.label"/></a>
            </span>
          </span>
          <span class="dex-PushButton">
            <span class="first-child">
