...
String sortIcon = URL + "/jsp/jahia/engines/images/icons/sort_" + ("1".equals(asc) ? "ascending" : "descending") + ".gif";
...
for (int z = 2; z < 5; z++) {
    ...
    if (z != 4) {
        ...
        sb.append((z + 1));
        sb.append("')\" title=\"").append(bundle.getString(bundle_prefix + ".criteria.add.label")).append("\"><img src=\"").append(URL).append("/jsp/jahia/engines/images/adding.png\" width=\"16\"height=\"16\" border=\"0\"></a>");
    }
    sb.append("<a href=\"javascript:contractcontent('sc");
    sb.append(z);
    sb.append("')\" title=\"").append(bundle.getString(bundle_prefix + ".criteria.remove.label")).append("\"><img src=\"").append(URL).append("/jsp/jahia/engines/images/deleting.png\" width=\"16\" height=\"16\" border=\"0\"></a>");
    sb.append("  </td>");
    sb.append("</tr>");
    sb.append("</table>");
...
<script type="text/javascript">
  ...
  function displayPickers(id) {
      ...
      myWin = window.open("<%=URL%>/jsp/jahia/engines/importexport/dispPickers.jsp?id=" + id, "jwin", "scrollbars=yes,width=600,height=400");
  }
  ...
  function displayWaiting() {
    document.getElementById("waiting").src = "<%=URL%>/jsp/jahia/engines/images/waiting.gif";
  }
  ...
  waitingimage.src = "<%=URL%>/jsp/jahia/engines/images/waiting.gif";
      ...
      <div class="head">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="object-title">
          <tr>
            ...
            <td>
              <img id="waiting" src="<%=URL%>/jsp/jahia/engines/images/pix.gif" width="16" height="16" border="0" align="absmiddle">
            </td>
          </tr>
        </table>
      </div>
          ...
          <tr>
            ...
            <td width="40">
              <a href="javascript:expandcontent('sc2')" title="<%=bundle.getString(bundle_prefix+".criteria.add.label")%>">
                <img src="<%=URL%>/jsp/jahia/engines/images/adding.png" width="16" height="16" border="0" alt="<%=bundle.getString(bundle_prefix+".criteria.add.label")%>"></a>&nbsp;&nbsp;&nbsp;
            </td>
          </tr>
        </table>
      </div>
