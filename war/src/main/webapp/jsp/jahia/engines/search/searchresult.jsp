...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}<internal:engineResourceBundle resourceName="org.jahia.stylesheet.css"/>" type="text/css">
</head>

<body class="text" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="window.focus(); MM_preloadImages('${pageContext.request.contextPath}<internal:engineResourceBundle resourceName="org.jahia.cancelOn.button"/>','${pageContext.request.contextPath}<internal:engineResourceBundle resourceName="org.jahia.okOn.button"/>');">
<table width="100%" height="63" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td height="63" width="100%" background="${pageContext.request.contextPath}<internal:engineResourceBundle resourceName="org.jahia.headerBg.image"/>">&nbsp;</td>
    </tr>
</table>
<br>
<p class="text">
&nbsp;&nbsp;&nbsp;<b><internal:engineResourceBundle resourceName="org.jahia.engines.search.Search_Engine.searchResultsFor.label"/>[</b><%=searchString%><b>]</b>
</p>
...
<%  if ((searchResults != null) && (searchResults.results().size() != 0))
    {
        for (JahiaSearchHit thisHit : searchResults.results())
        {
           ...
           - <internal:engineResourceBundle resourceName="org.jahia.engines.search.Search_Engine.score.label"/> : <%=thisHit.getScore()%><br>
