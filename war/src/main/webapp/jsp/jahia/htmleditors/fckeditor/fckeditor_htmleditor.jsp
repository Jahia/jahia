...
<%
    ...
    final String fckUrl = buff.append(request.getContextPath()).append("/jsp/jahia/htmleditors/fckeditor/").toString();
...
<script type="text/javascript">
    ...
    <%}%>
		...
		oFCKeditor.Config.ImageBrowserURL = "<c:url value='/jsp/jahia/engines/webdav/filePicker.jsp?callback=SetUrl&callbackType=url'><c:param name='filters' value='*.bmp,*.gif,*.jpe,*.jpeg,*.jpg,*.png,*.tif,*.tiff'/></c:url>";

		oFCKeditor.Config.FileBrowserURL = "<c:url value='/jsp/jahia/engines/webdav/filePicker.jsp?callback=SetUrl&callbackType=url'/>";
		
		oFCKeditor.Config.FlashBrowserURL = "<c:url value='/jsp/jahia/engines/webdav/filePicker.jsp?callback=SetUrl&callbackType=url&filters=*.swf'/>";
		
        oFCKeditor.Config.LinkBrowserURL = "<%=selectPageURL%>";

        oFCKeditor.Config["DefaultLanguage"] = "<%=currentLanguageCode%>";
        oFCKeditor.Config["CustomConfigurationsPath"] = "<c:url value='/jsp/jahia/htmleditors/fckeditor/fckconfig_jahia.js'/>"
