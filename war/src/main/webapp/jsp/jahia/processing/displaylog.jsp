...
<table cellspacing="0" cellpadding="15" width="100%" border="0" bgcolor="#FFFFFF">
    <tr valign="bottom">
        <td width="48px">
            <a href="javascript:history.back()" alt="back" title="back"><img src="<%=request.getContextPath()%>/jsp/jahia/engines/images/gauge.gif" width="48" height="48" border="0"></a></td>
        <td align="left"><h3>
            ...
            <table border="0" width="100%">
                <tr>
                    <td width="48"><img name="logo"
                                        src="<%=request.getContextPath()%>/jsp/jahia/css/images/logo/logo-jahia.gif"
                                        border="0"
                                        width="45" height="34"></td>
                    <td><img
                            src="<%=request.getContextPath()%>/jsp/jahia/engines/images/pix.gif" border="0" width="1"
                            height="10">
