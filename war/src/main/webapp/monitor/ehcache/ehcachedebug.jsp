...
<%@ page import="org.jahia.services.cache.SkeletonCache" %>
<%@ page import="net.sf.ehcache.Cache" %>
<%@ page import="net.sf.ehcache.Statistics" %>
<%@ page import="java.util.List" %>
<%@ page import="org.jahia.services.cache.CacheEntry" %>
<%@ page import="org.jahia.services.cache.SkeletonCacheEntry" %>
...
<html>
  ...
  <%
      ...
      Cache skeletonCache = cacheManager.getCache(SkeletonCache.SKELETON_CACHE);
      Statistics statistics = skeletonCache.getStatistics();
      List keys = skeletonCache.getKeys();
  ...
  <a href="index.html">index</a>
    <div id="statistics">
        ...
        <span>Memory size = <%=skeletonCache.getMemoryStoreSize()%></span><br/>
        <span>Disk size = <%=skeletonCache.getDiskStoreSize()%></span><br/>
    </div>
    <div id="keys">
        <table>
        <%
        ...
        %>
        <tr><td>key : <%=o.getKey()%></td></tr><tr><td>value : <%=((SkeletonCacheEntry) ((CacheEntry) skeletonCache.get(o).getValue()).getObject()).getContentBody().replaceAll("<","&lt;").replaceAll(">","&gt;")%></td></tr>
        <%                
            }
        %>
        </table>
