...
<html>
  ...
  <%
      ...
      Cache containerCache = cacheManager.getCache(ContainerHTMLCache.CONTAINER_HTML_CACHE+"-groups");
    ...
    <div id="keys">
        ...
        <%
            for (int i = 0; i < keys.size(); i++) {
                Object o = keys.get(i);
        %>
        <tr><td>key : <%=o%></td></tr><tr><td>value : <%=containerCache.get(o).getValue()%></td></tr>
        <%
            }
        %>
        </table>
