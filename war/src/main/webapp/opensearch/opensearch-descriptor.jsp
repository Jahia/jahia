...
<ShortName>Jahia CMS</ShortName>
<Description>Jahia CMS</Description>
...
<Url type="text/html" 
      method="get" template="${pageContext.request.contextPath}/<%=org.jahia.bin.Jahia.getServletPath()%>/engineName/search?search={searchTerms}" title="html search result">
</Url>
