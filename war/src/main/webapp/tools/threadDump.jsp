...
<% ErrorFileDumper.outputSystemInfo(new PrintWriter(pageContext.getOut()), false, false, false, false, true, true, false); %></c:if><c:if test="${not param.file}">
...
<c:set var="dump"><% ErrorFileDumper.outputSystemInfo(new PrintWriter(pageContext.getOut()), false, false, false, false, true, true, false); %></c:set>
