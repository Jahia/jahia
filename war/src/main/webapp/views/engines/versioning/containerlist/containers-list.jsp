  ...
  <div class="tabContent">
    ...
    <div id="content" class="fit w2">
      ...
      <div class="content-body padded">
        <internal:engineResourceBundle resourceName="org.jahia.engines.version.containerListVersioningExplanation.label" defaultValue="This interface only let you restore DELETED Containers." />
      </div>
      <%
      ...
      <div class="headtop">
        <div class="object-title">
          <internal:engineResourceBundle resourceName="org.jahia.engines.search.searchHitType.4"/>
        </div>
      </div>
...
--%>
        ...
        <display:column title='<%=JahiaResourceBundle.getEngineResource( "org.jahia.engines.version.operations", jParams, jParams.getLocale(),"Operations")%>' sortable="false" headerClass="lastCol" class="lastCol">
          <%if ( ctnVB.getIsDeleted() || ctnVB.getIsMarkedForDelete() ){ String params = "containerId=" + ctnVB.getId();%>
            <a href="javascript:sendForm('showConfirmUndelete','<%=params%>');"><internal:engineResourceBundle resourceName="org.jahia.engines.version.undelete" defaultValue="undelete"/></a>
          <%}%>
        </display:column>
      </display:table>
      <script type="text/javascript">
