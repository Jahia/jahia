...
<div class="dex-TabPanelBottom">
  <div class="tabContent">
    ...
    <div id="content" class="fit w2">
      <div class="head">
        <div class="object-title">
          <% if (pagesVersViewHelper.getOperationType() == 1) { %>
            <fmt:message key="org.jahia.engines.version.UndoStagingWizard"/>
          <% } else if (pagesVersViewHelper.getOperationType() == 2) { %>
            <fmt:message key="org.jahia.engines.version.restoreArchivedContent"/>
          <% } else { %>
            <fmt:message key="org.jahia.engines.version.ContentUndeleteWizard"/>
          <% } %>
          &nbsp;-&nbsp;<fmt:message key="org.jahia.engines.version.stepTwoOfThree"/>
        </div>
      </div>
      <% if (pagesVersViewHelper.getOperationType() == 1) { %>
        <table class="formTable" cellpadding="0" cellspacing="1" border="0" width="100%">
          <tr>
            ...
            <td align="left" valign="top">
              a)&nbsp;<fmt:message key="org.jahia.engines.version.undoStagingApplyToAllLanguages"/>!
            </td>
          </tr>
          <tr>

            <td align="left" valign="top">
              b)&nbsp;<fmt:message key="org.jahia.engines.version.pagesThatExistOnlyInStaging"/>.
            </td>
          </tr>
          <tr>
            <td align="left" valign="top">
              c)&nbsp;<fmt:message key="org.jahia.engines.version.previouslyDeletedPages"/>.
            </td>
          </tr>
        </table>
        ...
        <table class="formTable" cellpadding="0" cellspacing="1" border="0" width="100%">
          <tr>
            <th align="left" valign="top" width="100">
              <fmt:message key="org.jahia.engines.version.restoreDate"/> :
            </th>
            <td>
              <%
              ...
              <br/>
              <a href="javascript:sendForm('showRevisionsList')"><fmt:message key="org.jahia.engines.version.chooseTheDateFromRevisionsList"/>.</a><br>
            </td>
          </tr>
          <tr>
            <th align="left" valign="top">
              <fmt:message key="org.jahia.engines.version.restoreOptions"/> :
            </th>
            <td>
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="padding-top: 5px;">
                    <fmt:message key="org.jahia.engines.version.exactRestore"/> :<br />
                    <div style="padding:10px 0 0 25px;">
                      <fmt:message key="org.jahia.engines.version.exactRestoreDescription"/>.
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding-top: 5px;">
                    <fmt:message key="org.jahia.engines.version.partialRestore"/> :<br />
                    <div style="padding:10px 0 0 25px;">
                      <fmt:message key="org.jahia.engines.version.partialRestoreDescription"/>.
                    </div>
                  </td>
                </tr>
              </table>
      ...
      <div class="head">
        <div class="object-title">
          <fmt:message key="org.jahia.engines.version.pagesSelection"/>
        </div>
      </div>
      <% if (pagesVersViewHelper.getOperationType() == 2) { %>
        <p>
          <fmt:message key="org.jahia.engines.version.restorePageSelectionWarning"/>
          <a href="javascript:sendForm('showRevisionsList')"><fmt:message key="org.jahia.engines.version.chooseTheDateFromRevisionsList"/>.</a>
        </p>
      <% } %>
      <!--<p><span class="error">N.B:&nbsp;<fmt:message key="org.jahia.engines.version.lockedPages"/></span></p>-->
      <%
      // Restore specific
