...
<div class="dex-TabPanelBottom-full">
  <div class="tabContent">
    <div id="content" class="full">
      <div class="head">
        <div class="object-title"><internal:engineResourceBundle resourceName="org.jahia.engines.version.revisionDetail" /></div>
      </div>
      <table class="formTable" cellpadding="0" cellspacing="1" border="0" width="100%">
        <tr>
          <th width="100"><internal:engineResourceBundle resourceName="org.jahia.engines.version.dateOfRevision" />&nbsp;:&nbsp;</th>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td colspan="2" align="right" valign="top" nowrap>
            <br />
            <internal:engineResourceBundle resourceName="org.jahia.engines.version.legend" />&nbsp;:&nbsp;<span style='color:aqua'><internal:engineResourceBundle resourceName="org.jahia.engines.version.added" /></span>&nbsp;|&nbsp;<span style='color:lime'><internal:engineResourceBundle resourceName="org.jahia.engines.version.changed" /></span>&nbsp;|&nbsp;<span style='color:red;text-decoration:line-through;'><internal:engineResourceBundle resourceName="org.jahia.engines.version.deleted" /></span>&nbsp;&nbsp;&nbsp;<br />
            <br />
          </td>
        </tr>
        <tr>
          <td align="left" width="50%" valign="top">
            <div class="headtop">
              <div class="object-title"><internal:engineResourceBundle resourceName="org.jahia.engines.version.revisionTree" /></div>
            </div>
            <table class="text" border="0" cellspacing="0" cellpadding="0">
              ...
              for (int i = 0; i < flatRevisionsList.size(); i++) {
                ...
                <tr class="sitemap1">
                  ...
                  <% if ( selRevEntry != null && selRevEntry.equals(revEntry) ){ %>checked<% } %> ><internal:engineResourceBundle resourceName='<%= "org.jahia.services.version.entryState." + revEntry.getWorkflowState()%>'
          ...
          <td class="split" valign="top" align="left">
            <div class="headtop">
              <div class="object-title"><internal:engineResourceBundle resourceName="<%=oldValueStatus%>" />&nbsp;:&nbsp;</div>
            </div>
            <div class="padded">
              <br><%=oldValue%><br /><br />
            </div>
            <% if ( selRevEntry != null && selRevEntry.getWorkflowState()>0 && !isStagingValue.booleanValue() ){ %>
              <div class="head">
                <div class="object-title"><internal:engineResourceBundle resourceName="org.jahia.engines.version.valueStatus.3" />&nbsp;:&nbsp;</div>
              </div>
              <div class="padded">
                <br>No Staging<br /><br />
              </div>
            <% } else { %>
              <div class="head">
                <div class="object-title"><internal:engineResourceBundle resourceName="<%=newValueStatus%>" />&nbsp;:&nbsp;</div>
              </div>
              <div class="padded">
                <br><%=newValue%><br /><br />
              </div>
            <% } %>
            <div class="head">
              <div class="object-title"><internal:engineResourceBundle resourceName="org.jahia.engines.version.mergedDifference" />&nbsp;:&nbsp;</div>
            </div>
            <div class="padded">
